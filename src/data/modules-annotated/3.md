...
{{PAUSE:LIST}}- {{PAUSE:END}}Variación a lo largo del día
...
térmica).
{{PAUSE:LIST}}- {{PAUSE:END}}La nubosidad
...
menor.
{{PAUSE:LIST}}- {{PAUSE:END}}El viento
...
{{PAUSE:LIST}}- {{PAUSE:END}}La naturaleza  de  la  superficie  terrestre  en  la  que  se  mide  la  temperatura,  así  como  la  de  la
...
{{PAUSE:LIST}}- {{PAUSE:END}}La humedad relativa
...
época  del  año.  Esta  atmósfera  la definió  la {{PAUSE:ACRONYM}}OACI  y  fue  denominada atmósfera  {{PAUSE:ACRONYM}}ISA  (International
## Standard Atmosphere).
La atmósfera estándar tiene las siguientes características:
{{PAUSE:LIST}}- {{PAUSE:END}}Está formada por aire seco,  considerado como un gas perfecto que obedece a la ley de los gases
perfectos y con una masa molecular media de 0,02896442 kg/mol.
{{PAUSE:LIST}}- {{PAUSE:END}}A nivel del mar tiene una temperatura de 15ºC (288,15 K), una presión de 1013,25 hPa (760 mm
...
No puede ser usada, reproducida y/o transmitida por ningún medio,  sin la  autorización expresa de ENAIRE.
{{PAUSE:LIST}}
- {{PAUSE:END}}El gradiente térmico en la troposfera es de 2ºC por cada 1.000 ft de elevación (6,5ºC cada 1.000
...
Perfil vertical de temperatura según atmósfera {{PAUSE:ACRONYM}}ISA.
...
Valores de presión y temperatura de la atmósfera {{PAUSE:ACRONYM}}ISA a distintas altitudes.
...
según la latitud, hacen que la atmósfera real pueda diferir significativamente de la atmósfera {{PAUSE:ACRONYM}}ISA.
## 2.10.2  Altimetría.
...
el uso de las reglas de la altimetría y según la atmósfera {{PAUSE:ACRONYM}}ISA definida anteriormente, convierten dicha
...
teniendo en cuenta las condiciones de la atmósfera {{PAUSE:ACRONYM}}ISA, pueden presentar diferencias con respecto
...
{{PAUSE:ACRONYM}}QNH: Es  la  presión  atmosférica  del  aeródromo  reducida  al  nivel  del  mar  en  condiciones  {{PAUSE:ACRONYM}}ISA.  La
...
{{PAUSE:ACRONYM}}QFE: Es la presión atmosférica del aeródromo medida por el barómetro de la oficina meteorológica
...
{{PAUSE:ACRONYM}}QNE: Es la presión estándar a nivel del mar. La ventanilla del altímetro se ajustará a la referencia de
...
presión de referencia ({{PAUSE:ACRONYM}}QNE). De esta manera, los aviones vuelan a
determinados niveles de vuelo.
Los valores para reglar un altímetro a {{PAUSE:ACRONYM}}QNH o {{PAUSE:ACRONYM}}QFE no son fijos, ya que varían con el paso del tiempo
...
En el caso de que el aeropuerto esté al nivel del mar, el {{PAUSE:ACRONYM}}QNH coincidirá con el {{PAUSE:ACRONYM}}QFE, si el aeropuerto
está por debajo del nivel del mar, {{PAUSE:ACRONYM}}QNH será menor que {{PAUSE:ACRONYM}}QFE y, si está por encima del nivel del mar,
{{PAUSE:ACRONYM}}QNH será mayor que {{PAUSE:ACRONYM}}QFE.
...
estándar de la {{PAUSE:ACRONYM}}OACI. Estos niveles de vuelo son niveles de crucero que siempre quedan por encima
...
altitudes y el altímetro está calado en {{PAUSE:ACRONYM}}QNH.
...
{{PAUSE:LIST}}- {{PAUSE:END}}Radiación en la Atmósfera.
...
No puede ser usada, reproducida y/o transmitida por ningún medio,  sin la  autorización expresa de ENAIRE.
{{PAUSE:LIST}}
- {{PAUSE:END}}Como consecuencia de estos gradientes térmicos entre latitudes se desarrollan las corrientes de
...
{{PAUSE:LIST}}- {{PAUSE:END}}   Otro proceso por el que se transfiere energía entre las latitudes es mediante las corrientes oceánicas que
...
{{PAUSE:LIST}}- {{PAUSE:END}}Circulación general atmosférica.
...
{{PAUSE:LIST}}- {{PAUSE:END}}El exceso de radiación en el ecuador produce un ascenso del aire, y este aire en altura se
desplaza desde la latitud más cálida a la más fría, es decir, del ecuador a los polos.
{{PAUSE:LIST}}- {{PAUSE:END}}En el Polo desciende el aire y se desplaza por la superficie hasta el ecuador para reemplazar
...
{{PAUSE:LIST}}- {{PAUSE:END}}Viento: conceptos básicos.
...
presión subtropical se denominan vientos alisios. Estos vientos soplan del {{PAUSE:ACRONYM}}NE en el hemisferio
norte y del {{PAUSE:ACRONYM}}SE en el hemisferio sur, convergiendo en el ecuador en una zona denominada Zona
...
el  {{PAUSE:ACRONYM}}NE  hacia  el  sur  en  el  hemisferio  norte  y  desde  el  {{PAUSE:ACRONYM}}SE  hacia  el  norte  en  el  hemisferio  sur,
...
{{PAUSE:LIST}}- {{PAUSE:END}}Anticiclones y depresiones.
...
- {{PAUSE:END}}Masas de aire y frentes.
7.1. Masas de aire.
...
oclusión
{{PAUSE:LIST}}
- {{PAUSE:END}}Variables meteorológicas.
## 8.1. Nubosidad.
...
para la formación del personal meteorológico de la clase {{PAUSE:ACRONYM}}IV (B.J. Retallack)
...
Mundial  ({{PAUSE:ACRONYM}}OMM-Nº407,  1993),  las  nubes  se  clasifican  en  10  géneros  en  función  de  su  forma  y
características.
...
Las  abreviaturas  {{PAUSE:ACRONYM}}OACI  utilizadas  en  los  mensajes  aeronáuticos  para  proporcionar  el  nivel  de
nubosidad, son las siguientes:
{{PAUSE:ACRONYM}}OVC: cielo cubierto.
{{PAUSE:ACRONYM}}BKN: nuboso (de 5 a 7 octas de cielo cubierto).
{{PAUSE:ACRONYM}}SCT: nubosidad dispersa (de 3 a 4 octas de cielo cubierto.
{{PAUSE:ACRONYM}}FEW: algunas nubes (de 1 a 2 octas de cielo cubierto).
{{PAUSE:ACRONYM}}NSC: Sin nubes de importancia para las operaciones.
{{PAUSE:ACRONYM}}CAVOK: Sin nubes, sin fenómenos significativos y con visibilidad mayor que 10 kilómetros.
...
de la capa de nubes más baja, siempre que ésta cubra más de la mitad del cielo ({{PAUSE:ACRONYM}}BKN/{{PAUSE:ACRONYM}}OVC) y se halle
...
## 8.2. Visibilidad.
Según  Anexo  3  {{PAUSE:ACRONYM}}OACI,  en  sentido  aeronáutico  se  entiende  por  visibilidad  horizontal  al  valor  más
...
brillante.  Este  valor  está  representado  por  el  alcance  óptico  meteorológico  ({{PAUSE:ACRONYM}}MOR,
...
visual en pista, {{PAUSE:ACRONYM}}RVR (Runway Visual Range) que se define como la distancia hasta la cual el piloto de
...
En  los  informes  meteorológicos  aeronáuticos  {{PAUSE:ACRONYM}}METAR/{{PAUSE:ACRONYM}}SPECI,   se  cifra  la  denominada  visibilidad
...
{{PAUSE:LIST}}
- {{PAUSE:END}}Fenómenos meteorológicos peligrosos para el vuelo.
...
Range, {{PAUSE:ACRONYM}}RVR). Como se vio anteriormente, este parámetro mide la distancia hasta la cual el piloto de
...
 Alteraciones  en  las  propiedades  s  de  la  aeronave  en  vuelo:  disminución  en  la
...
{{PAUSE:LIST}}- {{PAUSE:END}}El hielo  claro  (clear  icing)  es  un  tipo  de  depósito  de  hielo  homogéneo  casi  transparente,  de
...
{{PAUSE:LIST}}- {{PAUSE:END}}El hielo  granulado  (rime  icing)  es  un  tipo  de  depósito  de  hielo  de  color  blanco  y  opaco,  de
...
o Temperatura del avión ligeramente por debajo de 0ºC.
{{PAUSE:LIST}}- {{PAUSE:END}}La lluvia engelante se forma cuando las gotas de precipitación líquida que procede de una capa
...
No puede ser usada, reproducida y/o transmitida por ningún medio,  sin la  autorización expresa de ENAIRE.
{{PAUSE:LIST}}
- {{PAUSE:END}}El engelamiento  por  escarcha  o  nieve  húmeda  se  caracteriza  porque  este  tipo  de  nieve  está
...
Onda de montaña típica y turbulencia en aire claro ({{PAUSE:ACRONYM}}TAC).

 Turbulencia  en  aire  claro  ({{PAUSE:ACRONYM}}TAC):  Es  un  tipo  de  turbulencia  que  aparece  en  vuelos  de  alta
...
Generalmente la {{PAUSE:ACRONYM}}TAC se presenta:
...
{{PAUSE:ACRONYM}}TAC solicitará cambios de ruta o de nivel para poder evitarla.
...
{{PAUSE:LIST}}- {{PAUSE:END}}Formación:  Se  caracteriza  por  la  existencia  de  corrientes  ascendentes  que  elevan  el  aire
...
No puede ser usada, reproducida y/o transmitida por ningún medio,  sin la  autorización expresa de ENAIRE.
{{PAUSE:LIST}}
- {{PAUSE:END}}Madurez: Comienza cuando las gotas de agua líquida o de hielo comienzan a caer (chubascos
...
{{PAUSE:LIST}}
- {{PAUSE:END}}Disipación:   Comienza   cuando   desaparecen   las   corrientes   ascendentes.   Las   corrientes
