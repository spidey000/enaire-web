...
{{PAUSE:LIST}}
- {{PAUSE:END}}Introducción a los Factores Humanos  4
...
### 1.3.2 Safety I versus Safety {{PAUSE:ACRONYM}}II  13
...
{{PAUSE:LIST}}- {{PAUSE:END}}La comunicación humana  31
...
{{PAUSE:LIST}}- {{PAUSE:END}}La fatiga  38
...
## 5.6 El Reglamento ({{PAUSE:ACRONYM}}UE) 2017/373 y las {{PAUSE:ACRONYM}}SARPS de {{PAUSE:ACRONYM}}OACI sobre la gestión de la fatiga  44
...
## 6.5 Gestión del estrés ante incidente crítico Programa {{PAUSE:ACRONYM}}CISM  55
{{PAUSE:LIST}}- {{PAUSE:END}}Error humano  58
## 7.1 Modelo {{PAUSE:ACRONYM}}GEMS de Reason  58
## 7.2 Modelo {{PAUSE:ACRONYM}}TEM (Threat and Error Management)  60
{{PAUSE:LIST}}- {{PAUSE:END}}BIBLIOGRAFÍA  63
{{PAUSE:LIST}}
- {{PAUSE:END}}Introducción a los Factores Humanos
## 1.1 Definición de Factores Humanos Los términos factores humanos (human factors) actuaciones humanas (human performance) y ergonomía suelen confundirse entre ellos incluso hasta en textos de base normativa lo cual es  algo  lógico  puesto  que  están  muy  vinculados  {{PAUSE:ACRONYM}}OACI  distingue  entre factores  humanos  y actuaciones humanas de la siguiente manera en su Doc 10151
...
### 1.2.3 Modelo {{PAUSE:ACRONYM}}SHELL-O El  modelo  {{PAUSE:ACRONYM}}SHELL  (Edwards  1972  Hawkins  1993)  fue  propuesto  formalmente  como  modelo conceptual  de   Factores   Humanos   por   {{PAUSE:ACRONYM}}OACI   en   su   Circular   216-AN31   para   evaluar   las interacciones complejas entre el componente humano de un sistema y su entorno operacional ya  que  facilita  la  comprensión  de  los  Factores  Humanos    Una  versión  actualizada  de  este modelo incluye también los factores relativos a la organización como parte del sistema (SHELLO)  También permite identificar los precursores y diferentes contextos en los que ocurren los errores
...
En  el  centro  del  modelo  {{PAUSE:ACRONYM}}SHELL-O  se  encuentra  el  ser  humano  (L) que  puede  ser  aplicado  a cualquier operador de primera línea (controlador aéreo {{PAUSE:ACRONYM}}ATSEP piloto) el componente central y más flexible del sistema al cual deben ajustarse el resto de componentes si se quiere evitar la  afectación  del  sistema Algunos  factores  que  afectan  al  desempeño  humano  son  físicos  y fisiológicos (visión audición luz ruido estrés ritmos circadianos etc.) y otros son psicológicos
## FIGURA 2  ESQUEMA DEL MODELO {{PAUSE:ACRONYM}}SHELL-O

(conocimiento  y  experiencia  idoneidad  de  la  formación  motivación  confianza  toma  de decisiones  fatiga  carga  de  trabajo  trabajo  en  equipo  etc.)    Por  último  es  muy  importante destacar el impacto de los factores psicosociales en el individuo ya que incluyen los factores externos del sistema social de la persona tanto en su entorno laboral como fuera del mismo que suponen presiones adicionales Tal y como refleja {{PAUSE:ACRONYM}}OACI (2002) estos factores pueden influir en  el  enfoque  personal  de  la  situación  laboral  como  en  la  capacidad  de  manejar  el  estrés  y situaciones anómalas
...
o Relación elemento humano-elemento humano (L-L) Representa la relación entre el individuo y el resto de personas en su lugar de trabajo  Incluye el liderazgo la cooperación el trabajo en equipo ({{PAUSE:ACRONYM}}TRM) las relaciones entre el personal operativo y de gestión así como la cultura empresarial
...
Este  enfoque  sistémico  en  la  investigación  de sucesos  fue  adoptado  formalmente  por  {{PAUSE:ACRONYM}}OACI (1994) en su anexo 13
Por consiguiente en un contexto {{PAUSE:ACRONYM}}ATM las actividades de prevención y gestión de riesgos deben contemplar que los principales problemas no corresponden exclusivamente al Factor Humano sino  que  surgen  de  interacciones  mal  comprendidas  dentro  de  la  propia  organización  El personal  operacional  no  actúa  aisladamente  sino  en  el  marco  de  una  organización  con  una jerarquía de autoridad con el fin de realizar sus tareas con éxito
...
## FIGURA 3 - PRINCIPIOS {{PAUSE:ACRONYM}}SISTÉ{{PAUSE:ACRONYM}}MICOS DEFINIDOS POR  EUROCONTROL
...
## {{PAUSE:ACRONYM}}TABLA 1 - SAFETY I VERSUS SAFETY {{PAUSE:ACRONYM}}II – EUROCONTROL (2013)
...
Una clara ilustración es la implementación prematura de nuevos sistemas en un entorno {{PAUSE:ACRONYM}}ATM
...
## REQUISITOS SOBRE FACTORES HUMANOS ESPECÍ{{PAUSE:ACRONYM}}FICOS PARA PROVEEDORES DE SERVICIOS DE
## CONTROL DEL {{PAUSE:ACRONYM}}TRÁ{{PAUSE:ACRONYM}}NSITO {{PAUSE:ACRONYM}}AÉ{{PAUSE:ACRONYM}}REO PUBLICADOS TEXTUALMENTE EN EL REGLAMENTO EUROPEO
## ({{PAUSE:ACRONYM}}UE) 2017/373 EN {{PAUSE:ACRONYM}}SU {{PAUSE:ACRONYM}}ANEXO {{PAUSE:ACRONYM}}IV {{PAUSE:ACRONYM}}SECCIÓN 3
➢ {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.300 Ámbito de aplicación Esta sección establece los requisitos que debe cumplir el proveedor de servicios de control del tránsito aéreo con respecto al desempeño humano para
...
➢ {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.305 Responsabilidades de los proveedores de servicios de control del tránsito aéreo con respecto al uso problemático de sustancias psicoactivas por los controladores de tránsito aéreo a El  proveedor  de  servicios  de  control  del tránsito aéreo desarrollará y  aplicará una política y  sus  procedimientos  relacionados  con  el  objeto  de  garantizar  que  el  uso problemático de sustancias psicoactivas no afecta a la prestación del servicio de control del tránsito aéreo
b Sin  perjuicio  de  lo  dispuesto  en  la  Directiva  95/46/{{PAUSE:ACRONYM}}CE  del  Parlamento  Europeo  y  del Consejo (1) y en la legislación nacional aplicable en materia de pruebas a personas el proveedor   de   servicios   de   control   del tránsito aéreo desarrollará y   aplicará un procedimiento objetivo transparente y no discriminador para la detección de casos de uso problemático de sustancias psicoactivas por parte de los controladores de tránsito aéreo Este procedimiento tendrá
## ́
en cuenta las disposiciones establecidas en el punto {{PAUSE:ACRONYM}}ATCO.A.015 del Reglamento ({{PAUSE:ACRONYM}}UE) 2015/340
c El procedimiento de la letra b) deberá ser aprobado por la autoridad competente

➢ {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.310 Estrés De conformidad con el punto {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.200 el proveedor de servicios de control del tránsito aéreo
a desarrollará
## ́
y mantendrá
## ́
...
## ́
a los controladores de tránsito aéreo programas de formación e información sobre   la   prevención   del   estrés   incluido   el   estrés   en   incidentes   críticos   que complementen la formación sobre factores humanos facilitada de conformidad con las secciones  3  y  4  de  la  subparte  D  del  anexo  I  del  Reglamento  ({{PAUSE:ACRONYM}}UE)  2015/340  de  la
## Comisión
➢ {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.315 Fatiga De conformidad con el punto {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.200 el proveedor de servicios de control del tránsito aéreo
a desarrollará
## ́
y   mantendrá una   política   relativa   a   la   gestión   de   la   fatiga   de   los controladores de tránsito aéreo b facilitará
## ́
a  los  controladores  de  tránsito  aéreo  programas  de  información  sobre  la prevención  de  la  fatiga  que  complementen  la  formación  sobre  factores  humanos facilitada  de  conformidad  con  las  secciones  3  y  4  de  la  subparte  D  del  anexo  I  del Reglamento ({{PAUSE:ACRONYM}}UE) 2015/340
➢ {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.320 Sistemas de turnos de los controladores de tránsito aéreo a el   proveedor   de   servicios   de   control   del   tránsito   aéreo   desarrollará   aplicará y supervisará un sistema de turnos para gestionar los riesgos de la fatiga ocupacional de los controladores de tránsito aéreo alternando de forma segura los períodos de servicio y descanso En el sistema de turnos el proveedor de servicios de control del tránsito aéreo especificará los siguientes elementos
{{PAUSE:LIST}}- {{PAUSE:END}}número máximo de días hábiles consecutivos de servicio
{{PAUSE:LIST}}
- {{PAUSE:END}}número máximo de horas por período de servicio
{{PAUSE:LIST}}- {{PAUSE:END}}duración máxima del servicio de control del tránsito aéreo sin descansos
{{PAUSE:LIST}}- {{PAUSE:END}}relación entre los períodos de servicio y los descansos sin prestar servicios de control del tránsito aéreo
{{PAUSE:LIST}}- {{PAUSE:END}}períodos de descanso mínimos
{{PAUSE:LIST}}- {{PAUSE:END}}número máximo de períodos de servicio consecutivos que incluyan la noche si procede dependiendo del número de horas de operaciones de la dependencia de control de tránsito aéreo en cuestión
{{PAUSE:LIST}}- {{PAUSE:END}}número mínimo de períodos de descanso tras un período de servicio que incluya horas nocturnas
{{PAUSE:LIST}}- {{PAUSE:END}}número mínimo de períodos de descanso en un mismo ciclo de turnos
...
## 1.5 Normativa en relación a las competencias en materia de Factores Humanos para ATCOs Los requisitos sobre factores humanos específicos para proveedores de Servicios de Control de tránsito  aéreo  publicados  en  el  Reglamento  Europeo  ({{PAUSE:ACRONYM}}UE)  2017/373  complementan  los  ya anteriormente dispuestos en el Reglamento ({{PAUSE:ACRONYM}}UE) 2015/340 de la Comisión de 20 de febrero de
...
o Introducción a los factores humanos técnicas de aprendizaje la relevancia de los factores humanos para el {{PAUSE:ACRONYM}}ATC los factores humanos y el {{PAUSE:ACRONYM}}ATC o Actuaciones humanas conducta individual cultura de seguridad y conducta profesional salud y bienestar trabajo en equipo necesidades básicas de las personas en el trabajo y estrés
o Error humano peligros de los errores la definición de error humano clasificación de errores análisis y gestión de riesgos o Comunicación importancia de una buena comunicación en {{PAUSE:ACRONYM}}ATC procesos y modos de comunicación o El entorno de trabajo ergonomía y la necesidad de un buen diseño equipamiento y herramientas automatización
...
▪ Factores psicológicos y cognitivos ▪ Factores médicos y fisiológicos fatiga y fitness ▪ Factores sociales y organizacionales {{PAUSE:ACRONYM}}TRM trabajo en equipo y roles conducta responsable
## ▪ Estrés
...
Está demostrado que aproximadamente el 70% del coste final del proyecto viene fijado por el desarrollo  en  el  primer  10%  del  ciclo  de  vida  del  proyecto  (EUROCONTROL-{{PAUSE:ACRONYM}}FAA  2010)  tal  y como se refleja en la siguiente figura

FIGURA 4   ESCENARIO DE COSTES DE ACUERDO A LA IMPLEMENTACIÓN DE 3 ESTRATEGIAS RELATIVAS A LA INTEGRACIÓN DE LOS FACTORES HUMANOS EN LA {{PAUSE:ACRONYM}}GESTIÓN DE PROYECTOS (EUROCONTROL/{{PAUSE:ACRONYM}}FAA 2010) Es mucho más efectivo cambiar el diseño de un sistema en las fases iniciales de desarrollo que una  vez  está  implementado  y  es  operativo  y  ahí  es  donde  una  intervención  de  Factores Humanos   es   crítica   Por   esta   razón   una   organización   debe   fijar   como   prioridad   la sistematización de la integración de los Factores Humanos en el desarrollo e implementación de todos los proyectos tecnológicos en el entorno {{PAUSE:ACRONYM}}ATM
En un entorno global tan competitivo como el de la  aérea a nivel europeo hay que asegurar que los planes de innovación en el entorno {{PAUSE:ACRONYM}}ATM definan los objetivos tecnológicos y operacionales en línea con los objetivos estratégicos de la organización La integración práctica de los Factores Humanos en la dirección y gestión de los proyectos en todas sus fases puede contribuir a conseguir estos objetivos
...
{{PAUSE:LIST}}
- {{PAUSE:END}}Factores organizacionales y sociales
...
## 2.2 Gestión de los recursos del equipo ({{PAUSE:ACRONYM}}TRM) {{PAUSE:ACRONYM}}TRM significa Team Resource Management o Gestión de Recursos de Equipo  Es un concepto derivado del {{PAUSE:ACRONYM}}CRM (Cockpit/Crew Resource Management) en aviación transpuesto al ámbito de control  aunque  se  utiliza  esta  terminología  en  otros  ámbitos  como  la  sanidad  la  energía nuclear o incluso las operaciones militares
Conceptualmente {{PAUSE:ACRONYM}}TRM es una filosofía de trabajo que trata de maximizar la eficiencia en las interacciones  interpersonales   y   en   el  uso  de  los   recursos  personales   que   emerge  del reconocimiento de que los seres humanos somos proclives a cometer errores y que éstos no se pueden eliminar en su totalidad
Desde un punto de vista práctico el concepto {{PAUSE:ACRONYM}}TRM comprende una batería de habilidades de gestión intrapersonal e interpersonal que permiten en último término hacer un uso efectivo de todos los recursos al alcance de una persona dentro de un equipo
Las habilidades {{PAUSE:ACRONYM}}TRM se clasifican en las siguientes categorías
{{PAUSE:LIST}}- {{PAUSE:END}}Trabajo en equipo
{{PAUSE:LIST}}- {{PAUSE:END}}Gestión de roles dentro de un equipo
{{PAUSE:LIST}}- {{PAUSE:END}}Comunicación interpersonal
{{PAUSE:LIST}}- {{PAUSE:END}}Conciencia situacional
{{PAUSE:LIST}}- {{PAUSE:END}}Resolución de problemas y toma de decisiones
{{PAUSE:LIST}}- {{PAUSE:END}}Gestión del estrés Cada  una  de  estas  habilidades  a  su  vez  pueden  dividirse  en  habilidades y  estrategias más concretas  y  todas  ellas  son  de  naturaleza  conductual  que  pueden  trazarse  a  aspectos concretos  del  funcionamiento  humano  y  por  tanto  están  íntimamente  relacionadas  con  el conocimiento  científico en factores  humanos  en  distintas  áreas   Por ello  se entiende que  el

{{PAUSE:ACRONYM}}TRM  es  una  aplicación  práctica  y  adaptada  de  los  factores  humanos  a  un  ámbito  profesional particular en este caso el {{PAUSE:ACRONYM}}ATM
Los principales beneficios de la aplicación del concepto {{PAUSE:ACRONYM}}TRM se concretan en
...
{{PAUSE:LIST}}- {{PAUSE:END}}Factores psicológicos
...
A continuación se describen dos aspectos fundamentales relativos al procesamiento humano de la información aplicado a un contexto {{PAUSE:ACRONYM}}ATM la conciencia situacional y la carga de trabajo mental
...
Endsley define el concepto de conciencia situacional como "la percepción de los elementos en el  entorno  dentro  de un  volumen de  tiempo  y  espacio  la  comprensión de  su  significado  y  la proyección de su estado en un futuro próximo" Endsley presenta tres niveles diferentes de {{PAUSE:ACRONYM}}SA
{{PAUSE:LIST}}- {{PAUSE:END}}la percepción de la situación
{{PAUSE:LIST}}- {{PAUSE:END}}la comprensión de la situación y
{{PAUSE:LIST}}- {{PAUSE:END}}la proyección de esa situación en el futuro

FIGURA 5  MODELO DE CONCIENCIA SITUACIONAL DE ENDSLEY Y {{PAUSE:ACRONYM}}SU RELACIÓN CON LOS PROCESOS DE
## {{PAUSE:ACRONYM}}TOMA DE DECISIÓN Y DE EJECUCIÓN {{PAUSE:ACRONYM}}ASÍ COMO DE FACTORES EXTERNOS E INDIVIDUALES
...
FIGURA 6 ELEMENTOS QUE INFLUENCIAN LA CONCIENCIA SITUACIONAL ({{PAUSE:ACRONYM}}ISAAC Y RUITENBERG 1997)
...
En {{PAUSE:ACRONYM}}TRM se trabaja mucho con el concepto de conciencia situacional y se incide en que cuando al modelo mental le falta información la mente lo rellena realizando asunciones basadas en experiencias pasadas o en lo más probable De aquí hay dos elementos vitales para seguridad
...
## 3.3 Carga de trabajo mental El concepto de carga de trabajo mental se ha investigado en una amplia variedad de campos tales como la aviación el entorno {{PAUSE:ACRONYM}}ATC en particular las operaciones militares o la conducción de vehículos La definición de carga de trabajo mental considera este concepto de acuerdo a un marco  de  factores  de  estrés  que  interactúan  en  un  individuo  y que por  tanto  tienen  un impacto  en  el  rendimiento  humano    Un  gran  número  de  estudios  científicos  señalan  3 dimensiones fundamentales que afectan la carga mental de trabajo
{{PAUSE:LIST}}- {{PAUSE:END}}Presión temporal de la tarea (tiempo disponible tiempo necesario)
{{PAUSE:LIST}}- {{PAUSE:END}}Recursos cognitivos de procesamiento que demanda la tarea
{{PAUSE:LIST}}- {{PAUSE:END}}Aspectos emocionales Por  tanto  la  carga  de  trabajo  mental  según  definición  de Sebastian y  del  Hoyo  (2002)  es  el conjunto  de  requerimientos  mentales  cognitivos  o  intelectuales  a  los  que  se  ve  sometido  el trabajador a lo largo de su jornada laboral es decir el nivel de esfuerzo intelectual necesario para desempeñar sus tareas
La norma {{PAUSE:ACRONYM}}UNE-EN {{PAUSE:ACRONYM}}ISO 10075-2 proporciona precisamente una serie de orientaciones técnicas y  organizativas  a  la  hora  de diseñar adecuadamente  los  sistemas  de  trabajo  en  cuanto  a  la prevención del riesgo de la carga de trabajo mental  Esta norma distingue entre presión (stress) mental  y  tensión  (strain)  mental    Se  describe  como presión mental  al  conjunto  de  todas  las influencias  apreciables  ejercidas  por  factores  externos  que  afectan  mentalmente  al  ser humano Tensión mental sería el efecto inmediato de la presión mental en el individuo
...
## 3) Anticipación
1) Agrupar los tráficos según necesidades (autorizados a {{PAUSE:ACRONYM}}ILS versus tráficos en espera)
...
{{PAUSE:LIST}}- {{PAUSE:END}}La comunicación humana Conocemos bien la importancia de la comunicación en el entorno ATC y sabemos lo que puede suponer una  incidencia al  respecto  un  fallo de comunicación  entre  torres  cuyo  resultado  es que los controladores no puedan hablarse entre sí para pasar los aviones de un sector a otro o iniciar  una  maniobra  de  aproximación  supone  una  urgencia  sobre  la  que  debemos  actuar inmediatamente dadas sus consecuencias
...
{{PAUSE:LIST}}- {{PAUSE:END}}Con independencia de la voluntad que tengamos por actuar de forma coordinada y de la corrección con la que me expreso pueden producirse distorsiones que no son “culpa de nadie” pero que desembocan en un malentendido y por tanto en un incidente
{{PAUSE:LIST}}- {{PAUSE:END}}Quien mejor comunica es quien mejor escucha
{{PAUSE:LIST}}- {{PAUSE:END}}Aquel que comunica tiene la responsabilidad de asegurarse de que el mensaje ha llegado adecuadamente Si no es así debe buscar vías alternativas para conseguirlo
...
{{PAUSE:LIST}}
- {{PAUSE:END}}La fatiga La fatiga es un estado natural del individuo que forma parte de su condición humana y que en la mayor parte de los casos no tiene un impacto significativo en la persona Sin embargo si no se presta atención a este estado su impacto en las capacidades físicas y mentales del individuo pueden ser muy importantes
...
Trabajar durante la noche es una característica inherente a la ocupación de {{PAUSE:ACRONYM}}CTA y este turno presenta una serie de peculiaridades respecto de la fatiga que le hacen diferente respecto del mismo  trabajo  desarrollado  durante  el  día  ya  que  tanto  las  condiciones  del  entorno  (por ejemplo  físicas  como  la  falta  de  luz  o  propias  del  tráfico  como  la  reducción  de  la  afluencia) como  las  del  propio  individuo  (fisiológicas)  son  distintas Por  otra  parte  hay  otros  factores inductores de fatiga no relacionada con los procesos circadianos que están vinculados con la carga de trabajo mental sostenida en el tiempo y que también pueden combinarse con factores circadianos con el estrés y con otros factores personales
Para  entender  mejor  la  relación  que  existe  entre  el  trabajo  de  {{PAUSE:ACRONYM}}CTA  y  la  fatiga  así  como  la necesidad de saber gestionar dicho estado es preciso hacer un repaso respecto de los principios científicos que rigen el patrón del sueño del ser humano
...
Según  la  Organización  Mundial de  la  Salud  ({{PAUSE:ACRONYM}}OMS)  y  la National  Sleep  Foundation  ({{PAUSE:ACRONYM}}EE.{{PAUSE:ACRONYM}}UU.)  un adulto  entre  los  18  y  los  64  años  debe  dormir  un  promedio  diario  de  8  horas  para  poder
...
a el sueño sin movimientos rápidos del ojo (sueño no-{{PAUSE:ACRONYM}}REM
## 2
) y b el sueño con movimientos rápidos del ojo (sueño {{PAUSE:ACRONYM}}REM) El sueño no-{{PAUSE:ACRONYM}}REM o fase de sueño lento se divide a su vez en cuatro fases con características diferentes así que en total se pueden distinguir sumando la fase de sueño {{PAUSE:ACRONYM}}REM cinco fases que  se  alternan  de  forma  cíclica  mientras  la  persona  permanece  dormida  (cada  90/100 minutos aproximadamente comienza un nuevo ciclo de sueño en el que los últimos 20 o 30 minutos se corresponden con la fase {{PAUSE:ACRONYM}}REM)
...
➢ Fase  {{PAUSE:ACRONYM}}II  en  esta  fase  el  sistema  nervioso  bloquea  las  vías  de  acceso  de  la  información sensorial  lo  que  origina  una  desconexión  con  el  entorno  facilitándose  por  tanto  la actividad de dormir Esta fase ocupa el 50% del tiempo de sueño en una persona adulta
...
➢ Fase {{PAUSE:ACRONYM}}III es un sueño más profundo (denominado {{PAUSE:ACRONYM}}DELTA) donde el bloqueo sensorial se intensifica   Si   el   individuo   se   despierta   durante   esta   fase   se   siente   confuso   y desorientado  En  esta  fase  no  se  sueña  se  produce  una  disminución  del  10  al  30  por ciento de la tensión arterial y del ritmo respiratorio y se incrementa la producción de la hormona del crecimiento El tono muscular es aún más reducido que en fase {{PAUSE:ACRONYM}}II y tampoco hay movimientos oculares
➢ Fase {{PAUSE:ACRONYM}}IV es la fase de mayor profundidad del sueño en la que la actividad cerebral es más lenta  (predominio  de  actividad  delta)  Al  igual  que  la  fase  {{PAUSE:ACRONYM}}III  es  esencial  para  la recuperación  física  y  especialmente  psíquica  del  organismo  (déficits  de  fase {{PAUSE:ACRONYM}}III  y  {{PAUSE:ACRONYM}}IV
...
➢ Proceso Circadiano (C) es el reloj corporal interno que regula funciones como la temperatura la producción hormonal etc rigiéndose por un patrón de 24 horas aproximadamente Su pico más bajo de actividad ocurre durante la segunda parte de la noche (aproximadamente entre las 3 y las 6 a.m.)  Este mínimo conocido como mínimo de la ventana circadiana ({{PAUSE:ACRONYM}}WOCL) coincide con el momento donde se alcanza la temperatura basal mínima corporal produciéndose entonces en el individuo la mayor somnolencia y la menor capacidad de desempeño
...
## 5.5 Carga de trabajo fatiga y nivel de desempeño La  Organización de  Aviación  Civil  Internacional  ({{PAUSE:ACRONYM}}OACI)  en  el Documento 9966  Manual  para  la supervisión de los enfoques de gestión de la fatiga de 2016 define la fatiga como aquel estado fisiológico que se caracteriza por una reducción de la capacidad de desempeño mental o físico debido  a  la  falta  de  sueño  o  a  períodos  prolongados  de  vigilia  fase  circadiana  y/o  carga  de trabajo (actividad mental y/o física) y que puede menoscabar el estado de alerta de una persona y su capacidad para desempeñar sus funciones relacionadas con la seguridad operacional
...
## FIGURA 8  {{PAUSE:ACRONYM}}LEY DE YERKES-DODSON
...
## 5.6 El Reglamento ({{PAUSE:ACRONYM}}UE) 2017/373 y las {{PAUSE:ACRONYM}}SARPS de {{PAUSE:ACRONYM}}OACI sobre la gestión de la fatiga Tanto la Unión Europea ({{PAUSE:ACRONYM}}UE) como {{PAUSE:ACRONYM}}OACI han establecido reglamentos y normas relativos a la gestión de la fatiga en el caso de la {{PAUSE:ACRONYM}}UE también respecto de la gestión del estrés aspecto que se tratará en el apartado correspondiente a este estado
La Unión Europea refleja los requisitos sobre la gestión de la fatiga relativa a los controladores de tránsito aéreo en el Reglamento de Ejecución ({{PAUSE:ACRONYM}}UE) 2017/373 de 1 de marzo de 2017 de la Comisión  por  el  que  se  establecen  requisitos  comunes  para  los  proveedores  de  servicios  de gestión del tránsito aéreo/ aérea y otras funciones de la red de gestión del tránsito aéreo y su supervisión En concreto en su Anexo {{PAUSE:ACRONYM}}IV Sección 3 donde aparecen los Requisitos sobre  Factores  Humanos Las  disposiciones  de  este  Reglamento  que  entra  en  vigor  el 02/01/2020  se  complementan  con  las  denominadas Easy  Rules de  {{PAUSE:ACRONYM}}EASA  (European  Aviation Safety Agency) donde para cada requisito o Implementing Rule definido en dicho Reglamento se describen medios aceptables de cumplimiento ({{PAUSE:ACRONYM}}AMC) y material guía ({{PAUSE:ACRONYM}}GM)
Otro  Reglamento  a  tener  en  cuenta  es  el  Reglamento  de  Ejecución  ({{PAUSE:ACRONYM}}UE)  2015/1018  de  la Comisión de 29 de junio de 2015 por el que se establece una lista de clasificación de los sucesos en  la  aviación  civil  de  notificación  obligatoria  En  su  anexo  {{PAUSE:ACRONYM}}III  respecto  de  los  Sucesos

relacionados con los servicios e instalaciones de  aérea establece la obligatoriedad de  notificación  tanto  para  el  proveedor  de  servicios  de  tránsito  aéreo  como  para  el  {{PAUSE:ACRONYM}}CTA respecto de “la fatiga que repercuta o pueda repercutir en la capacidad de ejercer de forma segura las funciones de  aérea o tránsito aéreo” Las  notificaciones  de  fatiga  constituyen  una  fuente  de  información  esencial  para  poder entender analizar y evaluar los riesgos asociados a la fatiga tanto si ésta se gestiona mediante un {{PAUSE:ACRONYM}}FRMS o de acorde a los límites prescriptivos
ENAIRE cuenta con un sistema integrado de gestión de riesgos de fatiga y estrés denominado {{PAUSE:ACRONYM}}FSRMS Fatigue and Stress Risk Management System
...
## SÍNTOMAS PSICOLÓ{{PAUSE:ACRONYM}}GICOS
## DE LA FATIGA
## SÍNTOMAS FISIOLÓ{{PAUSE:ACRONYM}}GICOS
## DE LA FATIGA
...
## FIGURA 9  RELACIÓN {{PAUSE:ACRONYM}}ENTRE LA FATIGA Y LA SEGURIDAD OPERACIONAL
...
Por tanto  trabajar  por  la  noche es una  característica  inherente  a  la  ocupación de  {{PAUSE:ACRONYM}}CTA  y este turno presenta una serie de peculiaridades que le hacen diferente respecto del mismo trabajo desarrollado durante el día ya que tanto las condiciones del entorno (por ejemplo físicas -falta de  luz-  o  propias  del  tráfico -reducción  de  la  afluencia-)  como  las  del  propio  individuo (fisiológicas) son distintas
...
## COMO AFECTA {{PAUSE:ACRONYM}}AL INDIVIDUO
...
FIGURA 10  MODELO TRANSACCIONAL DEL {{PAUSE:ACRONYM}}ESTRÉS DE {{PAUSE:ACRONYM}}COX-MACKAY FUENTE “MANAGING STRESS {{PAUSE:ACRONYM}}IN {{PAUSE:ACRONYM}}ATM”
## EUROCONTROL
...
o Hipoestrés Cuando el controlador de tránsito aéreo ({{PAUSE:ACRONYM}}CTA) se aburre o desempeña una tarea rutinaria siente poco interés y tensión con lo cual su desempeño puede ser pobre y las posibilidades de cometer errores son altas
...
En  términos  generales  el  estrés  experimentado  por  un  controlador  de  tráfico  aéreo  en  el trabajo es una función de sus niveles subyacentes de estrés relacionados con su estilo de vida su salud y bienestar la personalidad el entorno organizativo/laboral sus niveles de satisfacción vitales así como el estrés agudo impuesto por las condiciones operativas De acuerdo con {{PAUSE:ACRONYM}}EASA (GM1 {{PAUSE:ACRONYM}}ATS.{{PAUSE:ACRONYM}}OR.310 Stress – {{PAUSE:ACRONYM}}RE 2017/373) podemos distinguir tres fuentes principales de estrés en  el  ámbito  de  control aéreo estresores  ambientales/físicos estresores  relacionados  con  la tarea y relativos al individuo
...
Critical Incident Stress Management o {{PAUSE:ACRONYM}}CISM describe el conjunto de medidas y estrategias para afrontar  satisfactoriamente  estos  sucesos  y  prevenir  las  enfermedades  y  consecuencias negativas en la salud de los mismos
...
En un entorno {{PAUSE:ACRONYM}}ATC pueden ser considerados incidentes críticos los siguientes ejemplos
o Accidentes
...
Dada  la  importancia  de  las  consecuencias  descritas  ENAIRE  decidió  implantar  un  programa {{PAUSE:ACRONYM}}CISM  como  una  ayuda  estructurada  a  la  reacción  humana  ante  incidencias  {{PAUSE:ACRONYM}}ATC  de  carácter traumático  con el  objeto  de  moderar el  impacto  del  mismo  sobre el  controlador de tránsito aéreo y acelerar su regreso a la normalidad laboral
La  metodología  propuesta  consiste  en  la  implementación  de  un  programa  {{PAUSE:ACRONYM}}CISM  en  la organización basada en un modelo Peers Peer es la denominación inglesa que en este caso hace   referencia   a   un   controlador   de   apoyo   formado   específicamente   para   atender psicológicamente  a  otros  controladores  tras  la  ocurrencia  de  un  incidente  crítico  Esta intervención se ha de complementar con asistencia psicológica profesional cuando se estime necesario
El  programa  ha  de  disponer  de  un  grupo  de  Peers  voluntarios  seleccionados  y  formados específicamente  en  {{PAUSE:ACRONYM}}CISM  siguiendo  las  recomendaciones  y  estándares  de  la  International Critical Incident Stress Foundation ({{PAUSE:ACRONYM}}ICISF)
Los  Peers  deben  ser  controladores  aéreos  con  una  amplia  experiencia  en  la  profesión específicamente seleccionados y formados para apoyar a otros controladores que precisen una intervención  debido  al  estrés  generado  por  un  incidente  crítico  Son  controladores  que  se ofrecen voluntarios para operar el {{PAUSE:ACRONYM}}CISM  Las principales tareas a realizar serán
...
## FIGURA 11  EL MODELO {{PAUSE:ACRONYM}}TEM DEFINIDO POR {{PAUSE:ACRONYM}}OACI
...
➢ Estados no deseados Los  errores  y  amenazas  que  forman  parte  del  trabajo  cotidiano  del  controlador  pueden generar estados no deseados (undesired states) y estas situaciones no deseables pueden convertirse  en  un riesgo  para  la  seguridad  Para  el  método  {{PAUSE:ACRONYM}}TEM  como  herramienta  en  el análisis  de  los  riesgos  a  la  seguridad  de  las  operaciones  es  tan  importante  estudiar  las circunstancias no deseadas que se pueden crear en el desarrollo de las operaciones como el análisis de los errores y amenazas potenciales
...
## 8 BIBLIOGRAFÍA
ASOCIACIÓN {{PAUSE:ACRONYM}}ESPAÑ{{PAUSE:ACRONYM}}OLA DE NORMALIZACIÓN Y CERTIFICACIÓN (2001) Principios Ergonómicos Relativos a la Carga de Trabajo Mental {{PAUSE:ACRONYM}}UNE-EN {{PAUSE:ACRONYM}}ISO 10075-1 y 2 Madrid {{PAUSE:ACRONYM}}AENOR
ASOCIACIÓN {{PAUSE:ACRONYM}}ESPAÑ{{PAUSE:ACRONYM}}OLA DE NORMALIZACIÓN Y CERTIFICACIÓN (2005) Principios Ergonómicos Relativos a la Carga de Trabajo Mental {{PAUSE:ACRONYM}}UNE-EN {{PAUSE:ACRONYM}}ISO 10075-3 Madrid {{PAUSE:ACRONYM}}AENOR 21 p
...
Edwards E (1988) “Introductory Overview” in E.L Wiener & D.C Nagel (Eds) Human Factors in Aviation San Diego {{PAUSE:ACRONYM}}CA Academic Press
Endsley M.R (1999) “Situational Awareness in Aviation Systems” In Handbook of Aviation Human Factors ed by Garland D.J Wise J.A and Hopkin V.D  Mahwah {{PAUSE:ACRONYM}}NJ Lawrence
...
EUROCONTROL (2014) Systems Thinking for Safety Ten Principles A White Paper  Moving Towards Safety {{PAUSE:ACRONYM}}II Brussels EUROCONTROL
EUROCONTROL (2013) From Safety-I to Safety-{{PAUSE:ACRONYM}}II A White Paper Brussels EUROCONTROL
EUROCONTROL/{{PAUSE:ACRONYM}}FAA Action Plan 15 Safety (2010) Human Performance in Air Traffic Management Safety A White Paper Brussels EUROCONTROL
...
Everly G.S (2006) Assisting Individuals in Crisis 4th edn Ellycott City {{PAUSE:ACRONYM}}MD International Critical
## Incident Stress Foundation
Everly G.S Mitchell J.T (1997) Innovations in Disaster and Psychology Volume Two Critical Incident Stress Management a New Era and Standard of Care in Crisis Intervention Ellycott City {{PAUSE:ACRONYM}}MD Chevron

Hollnagel E (2014) Safety-I and Safety-{{PAUSE:ACRONYM}}II The Past and Future of Safety Management Farnham
## Ashgate
Hollnagel E (2009) The {{PAUSE:ACRONYM}}ETTO Principle Efficiency-Thoroughness Trade-off Why Things that Go
...
## Ashgate
Leonhardt J and Vogt J (Eds.) (2006) Critical Incident Stress Management {{PAUSE:ACRONYM}}CISM in Aviation
Aldershot {{PAUSE:ACRONYM}}UK Ashgate
Mitchell J.T (2006) Critical Incident Stress Management ({{PAUSE:ACRONYM}}CISM) Group Crisis Intervention   4th edn Ellycott City {{PAUSE:ACRONYM}}MD International Critical Incident Stress Foundation
...
Ellycott City {{PAUSE:ACRONYM}}MD Chevron
Mitchell J.T Everly G.S (1994) Human Elements Training for Emergency Services Public Safety and Disaster Personnel an Instructional Guide to Teaching Debriefing Crisis Intervention and Stress Management Programs Ellycott City {{PAUSE:ACRONYM}}MD Chevron
{{PAUSE:ACRONYM}}OACI (2016) Manual para la Supervisión de los Enfoques de Gestión de la Fatiga  Doc 9966 2nd ed  Montreal {{PAUSE:ACRONYM}}OACI
{{PAUSE:ACRONYM}}OACI (2011) Manual sobre la Observación Continua del Programa Universal de Auditoría de la Vigilancia de la Seguridad Operacional Doc 9735 {{PAUSE:ACRONYM}}AN/960 3rd ed Montreal {{PAUSE:ACRONYM}}OACI
{{PAUSE:ACRONYM}}OACI (2005) Manejo de Amenazas y Errores ({{PAUSE:ACRONYM}}TEM) en el Control de Tránsito Aéreo {{PAUSE:ACRONYM}}CIR 314 {{PAUSE:ACRONYM}}AN/178  Montreal {{PAUSE:ACRONYM}}OACI
{{PAUSE:ACRONYM}}OACI (1994) Anexo 13 al Convenio sobre Aviación Civil Internacional – Investigación de Accidentes e incidentes de Aviación Montreal {{PAUSE:ACRONYM}}OACI
...
Rasmussen J (1983) “Skills Rules and Knowledge Signals Signs and Symbols and other Distinctions in Human Performance Models” {{PAUSE:ACRONYM}}IEEE Transactions on Systems Man and
## Cybernetics 13 257-266

Reason J (1997) Managing the Risks of Organizational Accidents Farnham Ashgate
Reason J (1990) Human error New York Cambridge University Press
Reason J (1987) “Generic Error-Modelling Systems ({{PAUSE:ACRONYM}}GEMS) A Cognitive Framework for Locating Common Human Error Forms” in New Technology and Human Error ed by Rasmussen K Duncan K and Leplat J Chichester:Wiley 63-83
Reglamento de Ejecución ({{PAUSE:ACRONYM}}UE) 2017/373 por el que se establecen los Requisitos Comunes para los Proveedores de Servicios de Gestión del Tránsito Aéreo/ Aérea y otras Funciones de la Red de Gestión del Tránsito Aéreo y su Supervisión por el que se derogan el Reglamento ({{PAUSE:ACRONYM}}CE) nº 482/2008 y los Reglamentos de Ejecución ({{PAUSE:ACRONYM}}UE) nº 1034/2011 ({{PAUSE:ACRONYM}}UE) nº 1035/2011 y ({{PAUSE:ACRONYM}}UE) 2016/1377 y por el que se modifica el Reglamento ({{PAUSE:ACRONYM}}UE) nº 677/2011 Bruselas La Comisión
## Europea
Reglamento ({{PAUSE:ACRONYM}}UE) 2015/340 de la Comisión de 20 de febrero de 2015 por el que se establecen Requisitos Técnicos y Procedimientos Administrativos relativos a las Licencias y los Certificados de los Controladores de Tránsito Aéreo en virtud del Reglamento ({{PAUSE:ACRONYM}}CE) nº 216/2008 del Parlamento Europeo y del Consejo se modifica el Reglamento de Ejecución ({{PAUSE:ACRONYM}}UE) nº 923/2012 de la Comisión y se deroga el Reglamento ({{PAUSE:ACRONYM}}UE) nº 805/2011 de la Comisión Bruselas La Comisión
## Europea
Reglamento ({{PAUSE:ACRONYM}}UE) 376/2014 del Parlamento Europeo y del Consejo de 3 de abril de 2014 relativo a la Notificación de Sucesos en la Aviación Civil que modifica el Reglamento ({{PAUSE:ACRONYM}}UE) nº 996/2010 del Parlamento Europeo y del Consejo y por el que se derogan la Directiva 2003/42/{{PAUSE:ACRONYM}}CE del Parlamento Europeo y del Consejo y los Reglamentos ({{PAUSE:ACRONYM}}CE) nº 1321/2007 y ({{PAUSE:ACRONYM}}CE) nº 1330/2007 de la Comisión Bruselas Parlamento Europeo y Consejo de la Unión Europea
Salvendy G (2012) The Handbook of Human Factors and Ergonomics  4 th edn Hoboken {{PAUSE:ACRONYM}}NJ
## John Wiley & Sons Inc
Shorrock S Williams C (2017) Human Factors and Ergonomics in Practice  Improving System Performance and Human Well-Being in the Real World Boca Raton {{PAUSE:ACRONYM}}FL {{PAUSE:ACRONYM}}CRC Press Simon H (1957)  Models of Man (Social and Rational) New York John Wiley and Sons
