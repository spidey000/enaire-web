...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Introducción a los Factores Humanos  4
...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Factores organizacionales y sociales  22
## 2.1 Trabajo en equipo y funciones del equipo 22
## 2.2 Gestión de los recursos del equipo ({{PAUSEACRONYM}}TRM)  23
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Factores psicológicos  24
...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- La comunicación humana  31
...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- La fatiga  38
...
## 5.6 El Reglamento ({{PAUSEACRONYM}}UE) 2017/373 y las {{PAUSEACRONYM}}SARPS de {{PAUSEACRONYM}}OACI sobre la gestión de la fatiga  44
## 5.7 Aptitud física  45

{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Estrés  48
...
## 6.5 Gestión del estrés ante incidente crítico Programa {{PAUSEACRONYM}}CISM  55
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Error humano  58
## 7.1 Modelo {{PAUSEACRONYM}}GEMS de Reason  58
## 7.2 Modelo {{PAUSEACRONYM}}TEM (Threat and Error Management)  60
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- BIBLIOGRAFÍA  63

{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Introducción a los Factores Humanos
## 1.1 Definición de Factores Humanos Los términos factores humanos (human factors) actuaciones humanas (human performance) y ergonomía suelen confundirse entre ellos incluso hasta en textos de base normativa lo cual es  algo  lógico  puesto  que  están  muy  vinculados  {{PAUSEACRONYM}}OACI  distingue  entre factores  humanos  y actuaciones humanas de la siguiente manera en su Doc 10151
...
El estudio de los Factores Humanos en un entorno {{PAUSEACRONYM}}ATM es esencial para entender mejor si el impacto del diseño de la tecnología la selección del personal la formación los procedimientos los   roles   tareas   y   responsabilidades   así   como   la   propia   gestión   organizacional   está garantizando un rendimiento óptimo del sistema y una gestión de riesgos eficiente
...
Permitió proponer un modelo de clasificación (modelo {{PAUSEACRONYM}}GEMS General Error Modelling System) que se emplea hasta hoy que además aportó una visión alejada de los juicios de valor acerca de  los  errores  centrada  en  los  procesos  cognitivos  y  los  contextos  que  intervienen  en hacer emerger un determinado tipo de error
...
### 1.2.3 Modelo {{PAUSEACRONYM}}SHELL-O El  modelo  {{PAUSEACRONYM}}SHELL  (Edwards  1972  Hawkins  1993)  fue  propuesto  formalmente  como  modelo conceptual  de   Factores   Humanos   por   {{PAUSEACRONYM}}OACI   en   su   Circular   216-AN31   para   evaluar   las interacciones complejas entre el componente humano de un sistema y su entorno operacional ya  que  facilita  la  comprensión  de  los  Factores  Humanos    Una  versión  actualizada  de  este modelo incluye también los factores relativos a la organización como parte del sistema (SHELLO)  También permite identificar los precursores y diferentes contextos en los que ocurren los errores
...
En  el  centro  del  modelo  {{PAUSEACRONYM}}SHELL-O  se  encuentra  el  ser  humano  (L) que  puede  ser  aplicado  a cualquier operador de primera línea (controlador aéreo {{PAUSEACRONYM}}ATSEP piloto) el componente central y más flexible del sistema al cual deben ajustarse el resto de componentes si se quiere evitar la  afectación  del  sistema Algunos  factores  que  afectan  al  desempeño  humano  son  físicos  y fisiológicos (visión audición luz ruido estrés ritmos circadianos etc) y otros son psicológicos
## FIGURA 2  ESQUEMA DEL MODELO {{PAUSEACRONYM}}SHELL-O

(conocimiento  y  experiencia  idoneidad  de  la  formación  motivación  confianza  toma  de decisiones  fatiga  carga  de  trabajo  trabajo  en  equipo  etc)    Por  último  es  muy  importante destacar el impacto de los factores psicosociales en el individuo ya que incluyen los factores externos del sistema social de la persona tanto en su entorno laboral como fuera del mismo que suponen presiones adicionales Tal y como refleja {{PAUSEACRONYM}}OACI (2002) estos factores pueden influir en  el  enfoque  personal  de  la  situación  laboral  como  en  la  capacidad  de  manejar  el  estrés  y situaciones anómalas
...
o Relación elemento humano-elemento humano (L-L) Representa la relación entre el individuo y el resto de personas en su lugar de trabajo  Incluye el liderazgo la cooperación el trabajo en equipo ({{PAUSEACRONYM}}TRM) las relaciones entre el personal operativo y de gestión así como la cultura empresarial
...
Este  enfoque  sistémico  en  la  investigación  de sucesos  fue  adoptado  formalmente  por  {{PAUSEACRONYM}}OACI (1994) en su anexo 13.
Por consiguiente en un contexto {{PAUSEACRONYM}}ATM las actividades de prevención y gestión de riesgos deben contemplar que los principales problemas no corresponden exclusivamente al Factor Humano sino  que  surgen  de  interacciones  mal  comprendidas  dentro  de  la  propia  organización  El personal  operacional  no  actúa  aisladamente  sino  en  el  marco  de  una  organización  con  una jerarquía de autoridad con el fin de realizar sus tareas con éxito
...
## {{PAUSEACRONYM}}TABLA 1 - SAFETY I VERSUS SAFETY {{PAUSEACRONYM}}II – EUROCONTROL (2013)
...
Una clara ilustración es la implementación prematura de nuevos sistemas en un entorno {{PAUSEACRONYM}}ATM
...
## 1
https//humanisticsystemscom/2016/12/05/the-varieties-of-human-work/

## REQUISITOS SOBRE FACTORES HUMANOS ESPECÍ{{PAUSEACRONYM}}FICOS PARA PROVEEDORES DE SERVICIOS DE
## CONTROL DEL {{PAUSEACRONYM}}TRÁ{{PAUSEACRONYM}}NSITO {{PAUSEACRONYM}}AÉ{{PAUSEACRONYM}}REO PUBLICADOS TEXTUALMENTE EN EL REGLAMENTO EUROPEO
## ({{PAUSEACRONYM}}UE) 2017/373 EN {{PAUSEACRONYM}}SU {{PAUSEACRONYM}}ANEXO {{PAUSEACRONYM}}IV SECCIÓN 3.
➢ {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.300 Ámbito de aplicación Esta sección establece los requisitos que debe cumplir el proveedor de servicios de control del tránsito aéreo con respecto al desempeño humano para
...
➢ {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.305 Responsabilidades de los proveedores de servicios de control del tránsito aéreo con respecto al uso problemático de sustancias psicoactivas por los controladores de tránsito aéreo a El  proveedor  de  servicios  de  control  del tránsito aéreo desarrollará y  aplicará una política y  sus  procedimientos  relacionados  con  el  objeto  de  garantizar  que  el  uso problemático de sustancias psicoactivas no afecta a la prestación del servicio de control del tránsito aéreo
b Sin  perjuicio  de  lo  dispuesto  en  la  Directiva  95/46/{{PAUSEACRONYM}}CE  del  Parlamento  Europeo  y  del Consejo (1) y en la legislación nacional aplicable en materia de pruebas a personas el proveedor   de   servicios   de   control   del tránsito aéreo desarrollará y   aplicará un procedimiento objetivo transparente y no discriminador para la detección de casos de uso problemático de sustancias psicoactivas por parte de los controladores de tránsito aéreo Este procedimiento tendrá
## ́
en cuenta las disposiciones establecidas en el punto {{PAUSEACRONYM}}ATCOA.015 del Reglamento ({{PAUSEACRONYM}}UE) 2015/340.
c El procedimiento de la letra b) deberá ser aprobado por la autoridad competente

➢ {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.310 Estrés De conformidad con el punto {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.200 el proveedor de servicios de control del tránsito aéreo
a desarrollará
## ́
y mantendrá
## ́
...
## ́
a los controladores de tránsito aéreo programas de formación e información sobre   la   prevención   del   estrés   incluido   el   estrés   en   incidentes   críticos   que complementen la formación sobre factores humanos facilitada de conformidad con las secciones  3  y  4  de  la  subparte  D  del  anexo  I  del  Reglamento  ({{PAUSEACRONYM}}UE)  2015/340  de  la
## Comisión
➢ {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.315 Fatiga De conformidad con el punto {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.200 el proveedor de servicios de control del tránsito aéreo
a desarrollará
## ́
y   mantendrá una   política   relativa   a   la   gestión   de   la   fatiga   de   los controladores de tránsito aéreo b facilitará
## ́
a  los  controladores  de  tránsito  aéreo  programas  de  información  sobre  la prevención  de  la  fatiga  que  complementen  la  formación  sobre  factores  humanos facilitada  de  conformidad  con  las  secciones  3  y  4  de  la  subparte  D  del  anexo  I  del Reglamento ({{PAUSEACRONYM}}UE) 2015/340.
➢ {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.320 Sistemas de turnos de los controladores de tránsito aéreo a el   proveedor   de   servicios   de   control   del   tránsito   aéreo   desarrollará   aplicará y supervisará un sistema de turnos para gestionar los riesgos de la fatiga ocupacional de los controladores de tránsito aéreo alternando de forma segura los períodos de servicio y descanso En el sistema de turnos el proveedor de servicios de control del tránsito aéreo especificará los siguientes elementos
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- número máximo de días hábiles consecutivos de servicio

{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- número máximo de horas por período de servicio
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- duración máxima del servicio de control del tránsito aéreo sin descansos
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- relación entre los períodos de servicio y los descansos sin prestar servicios de control del tránsito aéreo
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- períodos de descanso mínimos
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- número máximo de períodos de servicio consecutivos que incluyan la noche si procede dependiendo del número de horas de operaciones de la dependencia de control de tránsito aéreo en cuestión
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- número mínimo de períodos de descanso tras un período de servicio que incluya horas nocturnas
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- número mínimo de períodos de descanso en un mismo ciclo de turnos
...
## 1.5 Normativa en relación a las competencias en materia de Factores Humanos para ATCOs Los requisitos sobre factores humanos específicos para proveedores de Servicios de Control de tránsito  aéreo  publicados  en  el  Reglamento  Europeo  ({{PAUSEACRONYM}}UE)  2017/373  complementan  los  ya anteriormente dispuestos en el Reglamento ({{PAUSEACRONYM}}UE) 2015/340 de la Comisión de 20 de febrero de
...
o Introducción a los factores humanos técnicas de aprendizaje la relevancia de los factores humanos para el {{PAUSEACRONYM}}ATC los factores humanos y el {{PAUSEACRONYM}}ATC o Actuaciones humanas conducta individual cultura de seguridad y conducta profesional salud y bienestar trabajo en equipo necesidades básicas de las personas en el trabajo y estrés
o Error humano peligros de los errores la definición de error humano clasificación de errores análisis y gestión de riesgos o Comunicación importancia de una buena comunicación en {{PAUSEACRONYM}}ATC procesos y modos de comunicación o El entorno de trabajo ergonomía y la necesidad de un buen diseño equipamiento y herramientas automatización
...
▪ Factores psicológicos y cognitivos ▪ Factores médicos y fisiológicos fatiga y fitness ▪ Factores sociales y organizacionales {{PAUSEACRONYM}}TRM trabajo en equipo y roles conducta responsable
## ▪ Estrés
...
El concepto operacional básico en el programa {{PAUSEACRONYM}}SESAR se ha desarrollado bajo la premisa de que el Factor Humano es un pilar fundamental en la operación de los futuros sistemas {{PAUSEACRONYM}}ATM En ese sentido   es determinante   para   un   proveedor   de      aérea   disponer   de   una sistematización en la integración de los Factores Humanos en la implementación de tecnología
...
Está demostrado que aproximadamente el 70% del coste final del proyecto viene fijado por el desarrollo  en  el  primer  10%  del  ciclo  de  vida  del  proyecto  (EUROCONTROL-{{PAUSEACRONYM}}FAA  2010)  tal  y como se refleja en la siguiente figura

FIGURA 4.   ESCENARIO DE COSTES DE ACUERDO A LA IMPLEMENTACIÓN DE 3 ESTRATEGIAS RELATIVAS A LA INTEGRACIÓN DE LOS FACTORES HUMANOS EN LA GESTIÓN DE PROYECTOS (EUROCONTROL/{{PAUSEACRONYM}}FAA 2010) Es mucho más efectivo cambiar el diseño de un sistema en las fases iniciales de desarrollo que una  vez  está  implementado  y  es  operativo  y  ahí  es  donde  una  intervención  de  Factores Humanos   es   crítica   Por   esta   razón   una   organización   debe   fijar   como   prioridad   la sistematización de la integración de los Factores Humanos en el desarrollo e implementación de todos los proyectos tecnológicos en el entorno {{PAUSEACRONYM}}ATM
En un entorno global tan competitivo como el de la  aérea a nivel europeo hay que asegurar que los planes de innovación en el entorno {{PAUSEACRONYM}}ATM definan los objetivos tecnológicos y operacionales en línea con los objetivos estratégicos de la organización La integración práctica de los Factores Humanos en la dirección y gestión de los proyectos en todas sus fases puede contribuir a conseguir estos objetivos
...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Factores organizacionales y sociales
...
## 2.2 Gestión de los recursos del equipo ({{PAUSEACRONYM}}TRM) {{PAUSEACRONYM}}TRM significa Team Resource Management o Gestión de Recursos de Equipo  Es un concepto derivado del {{PAUSEACRONYM}}CRM (Cockpit/Crew Resource Management) en aviación transpuesto al ámbito de control  aunque  se  utiliza  esta  terminología  en  otros  ámbitos  como  la  sanidad  la  energía nuclear o incluso las operaciones militares
Conceptualmente {{PAUSEACRONYM}}TRM es una filosofía de trabajo que trata de maximizar la eficiencia en las interacciones  interpersonales   y   en   el  uso  de  los   recursos  personales   que   emerge  del reconocimiento de que los seres humanos somos proclives a cometer errores y que éstos no se pueden eliminar en su totalidad
Desde un punto de vista práctico el concepto {{PAUSEACRONYM}}TRM comprende una batería de habilidades de gestión intrapersonal e interpersonal que permiten en último término hacer un uso efectivo de todos los recursos al alcance de una persona dentro de un equipo
Las habilidades {{PAUSEACRONYM}}TRM se clasifican en las siguientes categorías
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Trabajo en equipo
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Gestión de roles dentro de un equipo
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Comunicación interpersonal
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Conciencia situacional
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Resolución de problemas y toma de decisiones
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Gestión del estrés Cada  una  de  estas  habilidades  a  su  vez  pueden  dividirse  en  habilidades y  estrategias más concretas  y  todas  ellas  son  de  naturaleza  conductual  que  pueden  trazarse  a  aspectos concretos  del  funcionamiento  humano  y  por  tanto  están  íntimamente  relacionadas  con  el conocimiento  científico en factores  humanos  en  distintas  áreas   Por ello  se entiende que  el

{{PAUSEACRONYM}}TRM  es  una  aplicación  práctica  y  adaptada  de  los  factores  humanos  a  un  ámbito  profesional particular en este caso el {{PAUSEACRONYM}}ATM
Los principales beneficios de la aplicación del concepto {{PAUSEACRONYM}}TRM se concretan en
o Programas de instrucción que tienen por objeto aumentar la cooperación y comunicación entre los miembros del grupo reduciendo la probabilidad de error o Mayor eficiencia en las actuaciones individuales y de grupo o Mejor utilización de los recursos humanos disponibles Distribución bien planificada de las cargas de trabajo y responsabilidades que evite saturar la capacidad de un individuo y produzca redundancia o Continuidad y estabilidad en la forma de trabajar del equipo o Mayor flexibilidad y capacidad de adaptación a situaciones nuevas o Mayor sentido de organización donde todos los equipos reciben la misma formación respecto a temas clave en la operación {{PAUSEACRONYM}}ATM o Mayor motivación
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Factores psicológicos
...
A continuación se describen dos aspectos fundamentales relativos al procesamiento humano de la información aplicado a un contexto {{PAUSEACRONYM}}ATM la conciencia situacional y la carga de trabajo mental
...
Endsley define el concepto de conciencia situacional como "la percepción de los elementos en el  entorno  dentro  de un  volumen de  tiempo  y  espacio  la  comprensión de  su  significado  y  la proyección de su estado en un futuro próximo" Endsley presenta tres niveles diferentes de {{PAUSEACRONYM}}SA
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- la percepción de la situación
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- la comprensión de la situación y
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- la proyección de esa situación en el futuro

FIGURA 5.  MODELO DE CONCIENCIA SITUACIONAL DE ENDSLEY Y {{PAUSEACRONYM}}SU RELACIÓN CON LOS PROCESOS DE
## {{PAUSEACRONYM}}TOMA DE DECISIÓN Y DE EJECUCIÓN ASÍ COMO DE FACTORES EXTERNOS E INDIVIDUALES
...
FIGURA 6. ELEMENTOS QUE INFLUENCIAN LA CONCIENCIA SITUACIONAL ({{PAUSEACRONYM}}ISAAC Y RUITENBERG 1997)
...
En {{PAUSEACRONYM}}TRM se trabaja mucho con el concepto de conciencia situacional y se incide en que cuando al modelo mental le falta información la mente lo rellena realizando asunciones basadas en experiencias pasadas o en lo más probable De aquí hay dos elementos vitales para seguridad
...
## 3.3 Carga de trabajo mental El concepto de carga de trabajo mental se ha investigado en una amplia variedad de campos tales como la aviación el entorno {{PAUSEACRONYM}}ATC en particular las operaciones militares o la conducción de vehículos La definición de carga de trabajo mental considera este concepto de acuerdo a un marco  de  factores  de  estrés  que  interactúan  en  un  individuo  y que por  tanto  tienen  un impacto  en  el  rendimiento  humano    Un  gran  número  de  estudios  científicos  señalan  3 dimensiones fundamentales que afectan la carga mental de trabajo
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Presión temporal de la tarea (tiempo disponible tiempo necesario)
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Recursos cognitivos de procesamiento que demanda la tarea
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Aspectos emocionales Por  tanto  la  carga  de  trabajo  mental  según  definición  de Sebastian y  del  Hoyo  (2002)  es  el conjunto  de  requerimientos  mentales  cognitivos  o  intelectuales  a  los  que  se  ve  sometido  el trabajador a lo largo de su jornada laboral es decir el nivel de esfuerzo intelectual necesario para desempeñar sus tareas
La norma {{PAUSEACRONYM}}UNE-EN {{PAUSEACRONYM}}ISO 10075-2 proporciona precisamente una serie de orientaciones técnicas y  organizativas  a  la  hora  de diseñar adecuadamente  los  sistemas  de  trabajo  en  cuanto  a  la prevención del riesgo de la carga de trabajo mental  Esta norma distingue entre presión (stress) mental  y  tensión  (strain)  mental    Se  describe  como presión mental  al  conjunto  de  todas  las influencias  apreciables  ejercidas  por  factores  externos  que  afectan  mentalmente  al  ser humano Tensión mental sería el efecto inmediato de la presión mental en el individuo
...
## 3) Anticipación
1) Agrupar los tráficos según necesidades (autorizados a {{PAUSEACRONYM}}ILS versus tráficos en espera)
...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- La comunicación humana Conocemos bien la importancia de la comunicación en el entorno {{PAUSEACRONYM}}ATC y sabemos lo que puede suponer una  incidencia al  respecto  un  fallo de comunicación  entre  torres  cuyo  resultado  es que los controladores no puedan hablarse entre sí para pasar los aviones de un sector a otro o iniciar  una  maniobra  de  aproximación  supone  una  urgencia  sobre  la  que  debemos  actuar inmediatamente dadas sus consecuencias
...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Con independencia de la voluntad que tengamos por actuar de forma coordinada y de la corrección con la que me expreso pueden producirse distorsiones que no son “culpa de nadie” pero que desembocan en un malentendido y por tanto en un incidente
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Quien mejor comunica es quien mejor escucha
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- Aquel que comunica tiene la responsabilidad de asegurarse de que el mensaje ha llegado adecuadamente Si no es así debe buscar vías alternativas para conseguirlo
...
Peroescuchar es ante todo una muestra de respeto y como tal lo solemos interpretar
...
{{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}LIST}}- La fatiga La fatiga es un estado natural del individuo que forma parte de su condición humana y que en la mayor parte de los casos no tiene un impacto significativo en la persona Sin embargo si no se presta atención a este estado su impacto en las capacidades físicas y mentales del individuo pueden ser muy importantes
...
Trabajar durante la noche es una característica inherente a la ocupación de {{PAUSEACRONYM}}CTA y este turno presenta una serie de peculiaridades respecto de la fatiga que le hacen diferente respecto del mismo  trabajo  desarrollado  durante  el  día  ya  que  tanto  las  condiciones  del  entorno  (por ejemplo  físicas  como  la  falta  de  luz  o  propias  del  tráfico  como  la  reducción  de  la  afluencia) como  las  del  propio  individuo  (fisiológicas)  son  distintas Por  otra  parte  hay  otros  factores inductores de fatiga no relacionada con los procesos circadianos que están vinculados con la carga de trabajo mental sostenida en el tiempo y que también pueden combinarse con factores circadianos con el estrés y con otros factores personales
Para  entender  mejor  la  relación  que  existe  entre  el  trabajo  de  {{PAUSEACRONYM}}CTA  y  la  fatiga  así  como  la necesidad de saber gestionar dicho estado es preciso hacer un repaso respecto de los principios científicos que rigen el patrón del sueño del ser humano
...
Según  la  Organización  Mundial de  la  Salud  ({{PAUSEACRONYM}}OMS)  y  la National  Sleep  Foundation  ({{PAUSEACRONYM}}EE{{PAUSEACRONYM}}UU)  un adulto  entre  los  18  y  los  64  años  debe  dormir  un  promedio  diario  de  8  horas  para  poder
...
a el sueño sin movimientos rápidos del ojo (sueño no-{{PAUSEACRONYM}}REM
## 2
) y b el sueño con movimientos rápidos del ojo (sueño {{PAUSEACRONYM}}REM) El sueño no-{{PAUSEACRONYM}}REM o fase de sueño lento se divide a su vez en cuatro fases con características diferentes así que en total se pueden distinguir sumando la fase de sueño {{PAUSEACRONYM}}REM cinco fases que  se  alternan  de  forma  cíclica  mientras  la  persona  permanece  dormida  (cada  90/100 minutos aproximadamente comienza un nuevo ciclo de sueño en el que los últimos 20 o 30 minutos se corresponden con la fase {{PAUSEACRONYM}}REM)
...
➢ Fase  {{PAUSEACRONYM}}II  en  esta  fase  el  sistema  nervioso  bloquea  las  vías  de  acceso  de  la  información sensorial  lo  que  origina  una  desconexión  con  el  entorno  facilitándose  por  tanto  la actividad de dormir Esta fase ocupa el 50% del tiempo de sueño en una persona adulta
...
➢ Fase {{PAUSEACRONYM}}III es un sueño más profundo (denominado {{PAUSEACRONYM}}DELTA) donde el bloqueo sensorial se intensifica   Si   el   individuo   se   despierta   durante   esta   fase   se   siente   confuso   y desorientado  En  esta  fase  no  se  sueña  se  produce  una  disminución  del  10  al  30  por ciento de la tensión arterial y del ritmo respiratorio y se incrementa la producción de la hormona del crecimiento El tono muscular es aún más reducido que en fase {{PAUSEACRONYM}}II y tampoco hay movimientos oculares
➢ Fase {{PAUSEACRONYM}}IV es la fase de mayor profundidad del sueño en la que la actividad cerebral es más lenta  (predominio  de  actividad  delta)  Al  igual  que  la  fase  {{PAUSEACRONYM}}III  es  esencial  para  la recuperación  física  y  especialmente  psíquica  del  organismo  (déficits  de  fase {{PAUSEACRONYM}}III  y  {{PAUSEACRONYM}}IV

## 2
Las siglas {{PAUSEACRONYM}}REM se corresponden con el nombre en inglés “Rapid Eye Movements”
...
➢ Fase  {{PAUSEACRONYM}}REM  En  esta  fase  se  presentan  los  sueños  en  forma  de  narración  con  un  hilo argumental aunque sea absurdo La actividad eléctrica cerebral de esta fase es rápida El tono muscular es nulo (atonía muscular o parálisis) impidiendo que la persona dormida materialice sus alucinaciones oníricas y pueda hacerse daño
Además  de  la  interrupción  de  ciclos  No-{{PAUSEACRONYM}}REM  y  {{PAUSEACRONYM}}REM  durante  el  sueño  factores  como  el envejecimiento  la  presencia  de  síntomas  asociados  a  trastornos  del  sueño  (por  ejemplo  la apnea)  la  influencia  de  factores  medioambientales  (como  una  inadecuada  iluminación  o temperatura)  o  la  ingesta  de  cafeína  alcohol  o  nicotina  pueden  afectar  negativamente  a  la calidad del sueño
Es importante recordar que los estudios realizados respecto de la calidad del descanso de los CTAs durante el turno de noche en su lugar de trabajo demuestran que este sueño es más ligero y  con frecuencia  interrumpido  (de  tipo No-{{PAUSEACRONYM}}REM)  no  pudiendo  compararse  con  la  calidad del sueño en el domicilio en las condiciones habituales para el individuo
...
➢ Proceso Circadiano (C) es el reloj corporal interno que regula funciones como la temperatura la producción hormonal etc rigiéndose por un patrón de 24 horas aproximadamente Su pico más bajo de actividad ocurre durante la segunda parte de la noche (aproximadamente entre las 3 y las 6 am)  Este mínimo conocido como mínimo de la ventana circadiana ({{PAUSEACRONYM}}WOCL) coincide con el momento donde se alcanza la temperatura basal mínima corporal produciéndose entonces en el individuo la mayor somnolencia y la menor capacidad de desempeño
...
## 5.5 Carga de trabajo fatiga y nivel de desempeño La  Organización de  Aviación  Civil  Internacional  ({{PAUSEACRONYM}}OACI)  en  el {{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}DOC}}Documento9966  Manual  para  la supervisión de los enfoques de gestión de la fatiga de 2016 define la fatiga como aquel estado fisiológico que se caracteriza por una reducción de la capacidad de desempeño mental o físico debido  a  la  falta  de  sueño  o  a  períodos  prolongados  de  vigilia  fase  circadiana  y/o  carga  de trabajo (actividad mental y/o física) y que puede menoscabar el estado de alerta de una persona y su capacidad para desempeñar sus funciones relacionadas con la seguridad operacional
...
## FIGURA 8  {{PAUSEACRONYM}}LEY DE YERKES-DODSON
...
## 5.6 El Reglamento ({{PAUSEACRONYM}}UE) 2017/373 y las {{PAUSEACRONYM}}SARPS de {{PAUSEACRONYM}}OACI sobre la gestión de la fatiga Tanto la Unión Europea ({{PAUSEACRONYM}}UE) como {{PAUSEACRONYM}}OACI han establecido reglamentos y normas relativos a la gestión de la fatiga en el caso de la {{PAUSEACRONYM}}UE también respecto de la gestión del estrés aspecto que se tratará en el apartado correspondiente a este estado
La Unión Europea refleja los requisitos sobre la gestión de la fatiga relativa a los controladores de tránsito aéreo en el Reglamento de Ejecución ({{PAUSEACRONYM}}UE) 2017/373 de 1 de marzo de 2017 de la Comisión  por  el  que  se  establecen  requisitos  comunes  para  los  proveedores  de  servicios  de gestión del tránsito aéreo/ aérea y otras funciones de la red de gestión del tránsito aéreo y su supervisión En concreto en su Anexo {{PAUSEACRONYM}}IV Sección 3 donde aparecen los Requisitos sobre  Factores  Humanos Las  disposiciones  de  este  Reglamento  que  entra  en  vigor  el 02/01/2020  se  complementan  con  las  denominadas Easy  Rules de  {{PAUSEACRONYM}}EASA  (European  Aviation Safety Agency) donde para cada requisito o Implementing Rule definido en dicho Reglamento se describen medios aceptables de cumplimiento ({{PAUSEACRONYM}}AMC) y material guía ({{PAUSEACRONYM}}GM)
Otro  Reglamento  a  tener  en  cuenta  es  el  Reglamento  de  Ejecución  ({{PAUSEACRONYM}}UE)  2015/1018  de  la Comisión de 29 de junio de 2015 por el que se establece una lista de clasificación de los sucesos en  la  aviación  civil  de  notificación  obligatoria  En  su  anexo  {{PAUSEACRONYM}}III  respecto  de  los  Sucesos

relacionados con los servicios e instalaciones de  aérea establece la obligatoriedad de  notificación  tanto  para  el  proveedor  de  servicios  de  tránsito  aéreo  como  para  el  {{PAUSEACRONYM}}CTA respecto de “la fatiga que repercuta o pueda repercutir en la capacidad de ejercer de forma segura las funciones de  aérea o tránsito aéreo” Las  notificaciones  de  fatiga  constituyen  una  fuente  de  información  esencial  para  poder entender analizar y evaluar los riesgos asociados a la fatiga tanto si ésta se gestiona mediante un {{PAUSEACRONYM}}FRMS o de acorde a los límites prescriptivos
ENAIRE cuenta con un sistema integrado de gestión de riesgos de fatiga y estrés denominado {{PAUSEACRONYM}}FSRMS Fatigue and Stress Risk Management System
...
## FATIGA
¿{{PAUSEACRONYM}}CTA consciente de la fatiga?
...
## FIGURA 9  RELACIÓN {{PAUSEACRONYM}}ENTRE LA FATIGA Y LA SEGURIDAD OPERACIONAL
...
Por tanto  trabajar  por  la  noche es una  característica  inherente  a  la  ocupación de  {{PAUSEACRONYM}}CTA  y este turno presenta una serie de peculiaridades que le hacen diferente respecto del mismo trabajo desarrollado durante el día ya que tanto las condiciones del entorno (por ejemplo físicas -falta de  luz-  o  propias  del  tráfico -reducción  de  la  afluencia-)  como  las  del  propio  individuo (fisiológicas) son distintas
...
## COMO AFECTA {{PAUSEACRONYM}}AL INDIVIDUO
...
FIGURA 10  MODELO TRANSACCIONAL DEL ESTRÉS DE {{PAUSEACRONYM}}COX-MACKAY FUENTE “MANAGING STRESS {{PAUSEACRONYM}}IN {{PAUSEACRONYM}}ATM”
## EUROCONTROL
...
En  términos  generales  el  estrés  experimentado  por  un  controlador  de  tráfico  aéreo  en  el trabajo es una función de sus niveles subyacentes de estrés relacionados con su estilo de vida su salud y bienestar la personalidad el entorno organizativo/laboral sus niveles de satisfacción vitales así como el estrés agudo impuesto por las condiciones operativas De acuerdo con {{PAUSEACRONYM}}EASA (GM1 {{PAUSEACRONYM}}ATS{{PAUSEACRONYM}}OR.310 Stress – {{PAUSEACRONYM}}RE 2017/373) podemos distinguir tres fuentes principales de estrés en  el  ámbito  de  control aéreo estresores  ambientales/físicos estresores  relacionados  con  la tarea y relativos al individuo
...
La  gestión  de  riesgos  relativos  al  estrés  debe  ser  considerada  un  componente  vital  de  la organización  al  proporcionar  una  oportunidad  significativa  de  maximizar  el  bienestar  del personal {{PAUSEACRONYM}}ATM con el propósito final de mejorar la seguridad y la eficiencia  En ese sentido la normativa europea sugiere una serie de medidas de mitigación
...
Critical Incident Stress Management o {{PAUSEACRONYM}}CISM describe el conjunto de medidas y estrategias para afrontar  satisfactoriamente  estos  sucesos  y  prevenir  las  enfermedades  y  consecuencias negativas en la salud de los mismos
...
En un entorno {{PAUSEACRONYM}}ATC pueden ser considerados incidentes críticos los siguientes ejemplos
o Accidentes
...
Dada  la  importancia  de  las  consecuencias  descritas  ENAIRE  decidió  implantar  un  programa {{PAUSEACRONYM}}CISM  como  una  ayuda  estructurada  a  la  reacción  humana  ante  incidencias  {{PAUSEACRONYM}}ATC  de  carácter traumático  con el  objeto  de  moderar el  impacto  del  mismo  sobre el  controlador de tránsito aéreo y acelerar su regreso a la normalidad laboral
La  metodología  propuesta  consiste  en  la  implementación  de  un  programa  {{PAUSEACRONYM}}CISM  en  la organización basada en un modelo Peers Peer es la denominación inglesa que en este caso hace   referencia   a   un   controlador   de   apoyo   formado   específicamente   para   atender psicológicamente  a  otros  controladores  tras  la  ocurrencia  de  un  incidente  crítico  Esta intervención se ha de complementar con asistencia psicológica profesional cuando se estime necesario
El  programa  ha  de  disponer  de  un  grupo  de  Peers  voluntarios  seleccionados  y  formados específicamente  en  {{PAUSEACRONYM}}CISM  siguiendo  las  recomendaciones  y  estándares  de  la  International Critical Incident Stress Foundation ({{PAUSEACRONYM}}ICISF)
Los  Peers  deben  ser  controladores  aéreos  con  una  amplia  experiencia  en  la  profesión específicamente seleccionados y formados para apoyar a otros controladores que precisen una intervención  debido  al  estrés  generado  por  un  incidente  crítico  Son  controladores  que  se ofrecen voluntarios para operar el {{PAUSEACRONYM}}CISM  Las principales tareas a realizar serán
...
## 7.2 Modelo {{PAUSEACRONYM}}TEM (Threat and Error Management) El modelo {{PAUSEACRONYM}}TEM es un concepto desarrollado por {{PAUSEACRONYM}}OACI que busca identificar el origen y la gestión de los errores en la interacción entre los controladores y su contexto operacional (organización procedimientos condiciones ambientales)  Este método permite establecer cómo se originan los errores cómo se responde a los errores cómo se detectan y cuáles son las consecuencias
...
## FIGURA 11  EL MODELO {{PAUSEACRONYM}}TEM DEFINIDO POR {{PAUSEACRONYM}}OACI
...
➢ Estados no deseados Los  errores  y  amenazas  que  forman  parte  del  trabajo  cotidiano  del  controlador  pueden generar estados no deseados (undesired states) y estas situaciones no deseables pueden convertirse  en  un riesgo  para  la  seguridad  Para  el  método  {{PAUSEACRONYM}}TEM  como  herramienta  en  el análisis  de  los  riesgos  a  la  seguridad  de  las  operaciones  es  tan  importante  estudiar  las circunstancias no deseadas que se pueden crear en el desarrollo de las operaciones como el análisis de los errores y amenazas potenciales
...
Edwards E (1988) “Introductory Overview” in EL Wiener & DC Nagel (Eds) Human Factors in Aviation San Diego {{PAUSEACRONYM}}CA Academic Press
Endsley MR (1999) “Situational Awareness in Aviation Systems” In Handbook of Aviation Human Factors ed by Garland DJ Wise JA and Hopkin VD  Mahwah {{PAUSEACRONYM}}NJ Lawrence
...
EUROCONTROL (2014) Systems Thinking for Safety Ten Principles A White Paper  Moving Towards Safety {{PAUSEACRONYM}}II Brussels EUROCONTROL
EUROCONTROL (2013) From Safety-I to Safety-{{PAUSEACRONYM}}II A White Paper Brussels EUROCONTROL
EUROCONTROL/{{PAUSEACRONYM}}FAA Action Plan 15 Safety (2010) Human Performance in Air Traffic Management Safety A White Paper Brussels EUROCONTROL
...
Everly GS (2006) Assisting Individuals in Crisis 4th edn Ellycott City {{PAUSEACRONYM}}MD International Critical
## Incident Stress Foundation
Everly GS Mitchell JT (1997) Innovations in Disaster and Psychology Volume Two Critical Incident Stress Management a New Era and Standard of Care in Crisis Intervention Ellycott City {{PAUSEACRONYM}}MD Chevron

Hollnagel E (2014) Safety-I and Safety-{{PAUSEACRONYM}}II The Past and Future of Safety Management Farnham
## Ashgate
Hollnagel E (2009) The {{PAUSEACRONYM}}ETTO Principle Efficiency-Thoroughness Trade-off Why Things that Go
## Right Sometimes Go Wrong Ashgate Publishing Ltd
Hopkin VD (1995) Human Factors in Air Traffic Control London Taylor and Francis
Isaac AR and Ruitenberg B (1999)  Air Traffic Control Human Performance Factors Aldershot
## Ashgate
Leonhardt J and Vogt J (Eds) (2006) Critical Incident Stress Management {{PAUSEACRONYM}}CISM in Aviation
Aldershot {{PAUSEACRONYM}}UK Ashgate
Mitchell JT (2006) Critical Incident Stress Management ({{PAUSEACRONYM}}CISM) Group Crisis Intervention   4th edn Ellycott City {{PAUSEACRONYM}}MD International Critical Incident Stress Foundation
Mitchell JT Everly GS (1996) Critical Incident Stress Debriefing An Operation Manual for the Prevention of Traumatic Stress among Emergency Services and Disaster Workers 2nd edn
Ellycott City {{PAUSEACRONYM}}MD Chevron
Mitchell JT Everly GS (1994) Human Elements Training for Emergency Services Public Safety and Disaster Personnel an Instructional Guide to Teaching Debriefing Crisis Intervention and Stress Management Programs Ellycott City {{PAUSEACRONYM}}MD Chevron
{{PAUSEACRONYM}}OACI (2016) Manual para la Supervisión de los Enfoques de Gestión de la Fatiga  {{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}DOC}}Doc9966. 2nd ed  Montreal {{PAUSEACRONYM}}OACI
{{PAUSEACRONYM}}OACI (2011) Manual sobre la Observación Continua del Programa Universal de Auditoría de la Vigilancia de la Seguridad Operacional {{{{PAUSEACRONYM}}PAUSE{{PAUSEACRONYM}}DOC}}Doc9735 {{PAUSEACRONYM}}AN/960. 3rd ed Montreal {{PAUSEACRONYM}}OACI
{{PAUSEACRONYM}}OACI (2005) Manejo de Amenazas y Errores ({{PAUSEACRONYM}}TEM) en el Control de Tránsito Aéreo {{PAUSEACRONYM}}CIR 314 {{PAUSEACRONYM}}AN/178  Montreal {{PAUSEACRONYM}}OACI
{{PAUSEACRONYM}}OACI (1994) Anexo 13 al Convenio sobre Aviación Civil Internacional – Investigación de Accidentes e incidentes de Aviación Montreal {{PAUSEACRONYM}}OACI
...
Rasmussen J (1983) “Skills Rules and Knowledge Signals Signs and Symbols and other Distinctions in Human Performance Models” {{PAUSEACRONYM}}IEEE Transactions on Systems Man and
## Cybernetics 13 257-266.

Reason J (1997) Managing the Risks of Organizational Accidents Farnham Ashgate
Reason J (1990) Human error New York Cambridge University Press
Reason J (1987) “Generic Error-Modelling Systems ({{PAUSEACRONYM}}GEMS) A Cognitive Framework for Locating Common Human Error Forms” in New Technology and Human Error ed by Rasmussen K Duncan K and Leplat J ChichesterWiley 63-83.
Reglamento de Ejecución ({{PAUSEACRONYM}}UE) 2017/373 por el que se establecen los Requisitos Comunes para los Proveedores de Servicios de Gestión del Tránsito Aéreo/ Aérea y otras Funciones de la Red de Gestión del Tránsito Aéreo y su Supervisión por el que se derogan el Reglamento ({{PAUSEACRONYM}}CE) nº 482/2008 y los Reglamentos de Ejecución ({{PAUSEACRONYM}}UE) nº 1034/2011 ({{PAUSEACRONYM}}UE) nº 1035/2011 y ({{PAUSEACRONYM}}UE) 2016/1377 y por el que se modifica el Reglamento ({{PAUSEACRONYM}}UE) nº 677/2011. Bruselas La Comisión
## Europea
Reglamento ({{PAUSEACRONYM}}UE) 2015/340 de la Comisión de 20 de febrero de 2015 por el que se establecen Requisitos Técnicos y Procedimientos Administrativos relativos a las Licencias y los Certificados de los Controladores de Tránsito Aéreo en virtud del Reglamento ({{PAUSEACRONYM}}CE) nº 216/2008 del Parlamento Europeo y del Consejo se modifica el Reglamento de Ejecución ({{PAUSEACRONYM}}UE) nº 923/2012 de la Comisión y se deroga el Reglamento ({{PAUSEACRONYM}}UE) nº 805/2011 de la Comisión Bruselas La Comisión
## Europea
Reglamento ({{PAUSEACRONYM}}UE) 376/2014 del Parlamento Europeo y del Consejo de 3 de abril de 2014 relativo a la Notificación de Sucesos en la Aviación Civil que modifica el Reglamento ({{PAUSEACRONYM}}UE) nº 996/2010 del Parlamento Europeo y del Consejo y por el que se derogan la Directiva 2003/42/{{PAUSEACRONYM}}CE del Parlamento Europeo y del Consejo y los Reglamentos ({{PAUSEACRONYM}}CE) nº 1321/2007 y ({{PAUSEACRONYM}}CE) nº 1330/2007 de la Comisión Bruselas Parlamento Europeo y Consejo de la Unión Europea
Salvendy G (2012) The Handbook of Human Factors and Ergonomics  4 th edn Hoboken {{PAUSEACRONYM}}NJ
## John Wiley & Sons Inc
Shorrock S Williams C (2017) Human Factors and Ergonomics in Practice  Improving System Performance and Human Well-Being in the Real World Boca Raton {{PAUSEACRONYM}}FL {{PAUSEACRONYM}}CRC Press Simon H (1957)  Models of Man (Social and Rational) New York John Wiley and Sons
