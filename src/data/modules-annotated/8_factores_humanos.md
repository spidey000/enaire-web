...
## 2.2 Gestión de los recursos del equipo (TRM{{pause:acronym}})  23
...
## 5.6 El Reglamento (UE{{pause:acronym}}) 2017/373 y las SARPS{{pause:acronym}} de OACI{{pause:acronym}} sobre la gestión de la fatiga  44
...
## 6.5 Gestión del estrés ante incidente crítico: Programa CISM{{pause:acronym}}  55
-{{pause:list}} Error humano  58
## 7.1 Modelo GEMS{{pause:acronym}} de Reason  58
## 7.2 Modelo TEM{{pause:acronym}} (Threat and Error Management)  60
-{{pause:list}} BIBLIOGRAFÍA  63

-{{pause:list}} Introducción a los Factores Humanos
## 1.1 Definición de Factores Humanos Los términos factores humanos (human factors) actuaciones humanas (human performance) y ergonomía suelen confundirse entre ellos incluso hasta en textos de base normativa lo cual es  algo  lógico  puesto  que  están  muy  vinculados  OACI{{pause:acronym}}  distingue  entre factores  humanos  y actuaciones humanas de la siguiente manera en su Doc 10151:
...
El estudio de los Factores Humanos en un entorno ATM{{pause:acronym}} es esencial para entender mejor si el impacto del diseño de la tecnología la selección del personal la formación los procedimientos los   roles   tareas   y   responsabilidades   así   como   la   propia   gestión   organizacional   está garantizando un rendimiento óptimo del sistema y una gestión de riesgos eficiente
...
Permitió proponer un modelo de clasificación (modelo GEMS{{pause:acronym}} General Error Modelling System) que se emplea hasta hoy que además aportó una visión alejada de los juicios de valor acerca de  los  errores  centrada  en  los  procesos  cognitivos  y  los  contextos  que  intervienen  en hacer emerger un determinado tipo de error
...
### 1.2.3 Modelo SHELL{{pause:acronym}}-O El  modelo  SHELL{{pause:acronym}}  (Edwards  1972  Hawkins  1993)  fue  propuesto  formalmente  como  modelo conceptual  de   Factores   Humanos   por   OACI{{pause:acronym}}   en   su   Circular   216-AN31   para   evaluar   las interacciones complejas entre el componente humano de un sistema y su entorno operacional ya  que  facilita  la  comprensión  de  los  Factores  Humanos    Una  versión  actualizada  de  este modelo incluye también los factores relativos a la organización como parte del sistema (SHELLO)  También permite identificar los precursores y diferentes contextos en los que ocurren los errores
...
En  el  centro  del  modelo  SHELL{{pause:acronym}}-O  se  encuentra  el  ser  humano  (L) que  puede  ser  aplicado  a cualquier operador de primera línea (controlador aéreo ATSEP{{pause:acronym}} piloto) el componente central y más flexible del sistema al cual deben ajustarse el resto de componentes si se quiere evitar la  afectación  del  sistema Algunos  factores  que  afectan  al  desempeño  humano  son  físicos  y fisiológicos (visión audición luz ruido estrés ritmos circadianos etc) y otros son psicológicos
## FIGURA 2  ESQUEMA DEL MODELO SHELL{{pause:acronym}}-O

(conocimiento  y  experiencia  idoneidad  de  la  formación  motivación  confianza  toma  de decisiones  fatiga  carga  de  trabajo  trabajo  en  equipo  etc)    Por  último  es  muy  importante destacar el impacto de los factores psicosociales en el individuo ya que incluyen los factores externos del sistema social de la persona tanto en su entorno laboral como fuera del mismo que suponen presiones adicionales Tal y como refleja OACI{{pause:acronym}} (2002) estos factores pueden influir en  el  enfoque  personal  de  la  situación  laboral  como  en  la  capacidad  de  manejar  el  estrés  y situaciones anómalas
...
o Relación elemento humano-elemento humano (L-L) Representa la relación entre el individuo y el resto de personas en su lugar de trabajo  Incluye el liderazgo la cooperación el trabajo en equipo (TRM{{pause:acronym}}) las relaciones entre el personal operativo y de gestión así como la cultura empresarial
...
Este  enfoque  sistémico  en  la  investigación  de sucesos  fue  adoptado  formalmente  por  OACI{{pause:acronym}} (1994) en su anexo 13.
Por consiguiente en un contexto ATM{{pause:acronym}} las actividades de prevención y gestión de riesgos deben contemplar que los principales problemas no corresponden exclusivamente al Factor Humano sino  que  surgen  de  interacciones  mal  comprendidas  dentro  de  la  propia  organización  El personal  operacional  no  actúa  aisladamente  sino  en  el  marco  de  una  organización  con  una jerarquía de autoridad con el fin de realizar sus tareas con éxito
...
## TABLA{{pause:acronym}} 1 - SAFETY I VERSUS SAFETY II{{pause:acronym}} – EUROCONTROL (2013)
...
Una clara ilustración es la implementación prematura de nuevos sistemas en un entorno ATM{{pause:acronym}}
...
## REQUISITOS SOBRE FACTORES HUMANOS ESPECÍFICOS{{pause:acronym}} PARA PROVEEDORES DE SERVICIOS DE
## CONTROL DEL TRA{{pause:acronym}}́NSITO{{pause:acronym}} AE{{pause:acronym}}́REO{{pause:acronym}} PUBLICADOS TEXTUALMENTE EN EL REGLAMENTO EUROPEO
## (UE{{pause:acronym}}) 2017/373 EN SU{{pause:acronym}} ANEXO{{pause:acronym}} IV{{pause:acronym}} SECCIÓN 3.
➢ ATSOR{{pause:acronym}}.300 Ámbito de aplicación Esta sección establece los requisitos que debe cumplir el proveedor de servicios de control del tránsito aéreo con respecto al desempeño humano para:
...
➢ ATSOR{{pause:acronym}}.305 Responsabilidades de los proveedores de servicios de control del tránsito aéreo con respecto al uso problemático de sustancias psicoactivas por los controladores de tránsito aéreo a El  proveedor  de  servicios  de  control  del tránsito aéreo desarrollará y  aplicará una política y  sus  procedimientos  relacionados  con  el  objeto  de  garantizar  que  el  uso problemático de sustancias psicoactivas no afecta a la prestación del servicio de control del tránsito aéreo
b Sin  perjuicio  de  lo  dispuesto  en  la  Directiva  95/46/CE{{pause:acronym}}  del  Parlamento  Europeo  y  del Consejo (1) y en la legislación nacional aplicable en materia de pruebas a personas el proveedor   de   servicios   de   control   del tránsito aéreo desarrollará y   aplicará un procedimiento objetivo transparente y no discriminador para la detección de casos de uso problemático de sustancias psicoactivas por parte de los controladores de tránsito aéreo Este procedimiento tendrá
## ́
en cuenta las disposiciones establecidas en el punto ATCOA{{pause:acronym}}.015 del Reglamento (UE{{pause:acronym}}) 2015/340.
c El procedimiento de la letra b) deberá ser aprobado por la autoridad competente

➢ ATSOR{{pause:acronym}}.310 Estrés De conformidad con el punto ATSOR{{pause:acronym}}.200 el proveedor de servicios de control del tránsito aéreo:
a desarrollará
## ́
y mantendrá
## ́
...
## ́
a los controladores de tránsito aéreo programas de formación e información sobre   la   prevención   del   estrés   incluido   el   estrés   en   incidentes   críticos   que complementen la formación sobre factores humanos facilitada de conformidad con las secciones  3  y  4  de  la  subparte  D  del  anexo  I  del  Reglamento  (UE{{pause:acronym}})  2015/340  de  la
## Comisión
➢ ATSOR{{pause:acronym}}.315 Fatiga De conformidad con el punto ATSOR{{pause:acronym}}.200 el proveedor de servicios de control del tránsito aéreo:
a desarrollará
## ́
y   mantendrá una   política   relativa   a   la   gestión   de   la   fatiga   de   los controladores de tránsito aéreo b facilitará
## ́
a  los  controladores  de  tránsito  aéreo  programas  de  información  sobre  la prevención  de  la  fatiga  que  complementen  la  formación  sobre  factores  humanos facilitada  de  conformidad  con  las  secciones  3  y  4  de  la  subparte  D  del  anexo  I  del Reglamento (UE{{pause:acronym}}) 2015/340.
➢ ATSOR{{pause:acronym}}.320 Sistemas de turnos de los controladores de tránsito aéreo a el   proveedor   de   servicios   de   control   del   tránsito   aéreo   desarrollará   aplicará y supervisará un sistema de turnos para gestionar los riesgos de la fatiga ocupacional de los controladores de tránsito aéreo alternando de forma segura los períodos de servicio y descanso En el sistema de turnos el proveedor de servicios de control del tránsito aéreo especificará los siguientes elementos:
-{{pause:list}} número máximo de días hábiles consecutivos de servicio

-{{pause:list}} número máximo de horas por período de servicio
-{{pause:list}} duración máxima del servicio de control del tránsito aéreo sin descansos
-{{pause:list}} relación entre los períodos de servicio y los descansos sin prestar servicios de control del tránsito aéreo
-{{pause:list}} períodos de descanso mínimos
-{{pause:list}} número máximo de períodos de servicio consecutivos que incluyan la noche si procede dependiendo del número de horas de operaciones de la dependencia de control de tránsito aéreo en cuestión
-{{pause:list}} número mínimo de períodos de descanso tras un período de servicio que incluya horas nocturnas
-{{pause:list}} número mínimo de períodos de descanso en un mismo ciclo de turnos
...
## 1.5 Normativa en relación a las competencias en materia de Factores Humanos para ATCOs Los requisitos sobre factores humanos específicos para proveedores de Servicios de Control de tránsito  aéreo  publicados  en  el  Reglamento  Europeo  (UE{{pause:acronym}})  2017/373  complementan  los  ya anteriormente dispuestos en el Reglamento (UE{{pause:acronym}}) 2015/340 de la Comisión de 20 de febrero de
...
o Introducción a los factores humanos: técnicas de aprendizaje la relevancia de los factores humanos para el ATC{{pause:acronym}} los factores humanos y el ATC{{pause:acronym}} o Actuaciones humanas: conducta individual cultura de seguridad y conducta profesional salud y bienestar trabajo en equipo necesidades básicas de las personas en el trabajo y estrés
o Error humano: peligros de los errores la definición de error humano clasificación de errores análisis y gestión de riesgos o Comunicación: importancia de una buena comunicación en ATC{{pause:acronym}} procesos y modos de comunicación o El entorno de trabajo: ergonomía y la necesidad de un buen diseño equipamiento y herramientas automatización
...
▪ Factores psicológicos y cognitivos ▪ Factores médicos y fisiológicos: fatiga y fitness ▪ Factores sociales y organizacionales: TRM{{pause:acronym}} trabajo en equipo y roles conducta responsable
## ▪ Estrés
...
El concepto operacional básico en el programa SESAR{{pause:acronym}} se ha desarrollado bajo la premisa de que el Factor Humano es un pilar fundamental en la operación de los futuros sistemas ATM{{pause:acronym}} En ese sentido   es determinante   para   un   proveedor   de      aérea   disponer   de   una sistematización en la integración de los Factores Humanos en la implementación de tecnología
...
Está demostrado que aproximadamente el 70% del coste final del proyecto viene fijado por el desarrollo  en  el  primer  10%  del  ciclo  de  vida  del  proyecto  (EUROCONTROL-FAA{{pause:acronym}}  2010)  tal  y como se refleja en la siguiente figura:

FIGURA 4.   ESCENARIO DE COSTES DE ACUERDO A LA IMPLEMENTACIÓN DE 3 ESTRATEGIAS RELATIVAS A LA INTEGRACIÓN DE LOS FACTORES HUMANOS EN LA GESTIÓN DE PROYECTOS (EUROCONTROL/FAA{{pause:acronym}} 2010) Es mucho más efectivo cambiar el diseño de un sistema en las fases iniciales de desarrollo que una  vez  está  implementado  y  es  operativo  y  ahí  es  donde  una  intervención  de  Factores Humanos   es   crítica   Por   esta   razón   una   organización   debe   fijar   como   prioridad   la sistematización de la integración de los Factores Humanos en el desarrollo e implementación de todos los proyectos tecnológicos en el entorno ATM{{pause:acronym}}
En un entorno global tan competitivo como el de la  aérea a nivel europeo hay que asegurar que los planes de innovación en el entorno ATM{{pause:acronym}} definan los objetivos tecnológicos y operacionales en línea con los objetivos estratégicos de la organización La integración práctica de los Factores Humanos en la dirección y gestión de los proyectos en todas sus fases puede contribuir a conseguir estos objetivos
...
TRM{{pause:acronym}}  es  una  aplicación  práctica  y  adaptada  de  los  factores  humanos  a  un  ámbito  profesional particular en este caso el ATM{{pause:acronym}}
Los principales beneficios de la aplicación del concepto TRM{{pause:acronym}} se concretan en:
...
A continuación se describen dos aspectos fundamentales relativos al procesamiento humano de la información aplicado a un contexto ATM{{pause:acronym}}: la conciencia situacional y la carga de trabajo mental
...
Endsley define el concepto de conciencia situacional como "la percepción de los elementos en el  entorno  dentro  de un  volumen de  tiempo  y  espacio  la  comprensión de  su  significado  y  la proyección de su estado en un futuro próximo" Endsley presenta tres niveles diferentes de SA{{pause:acronym}}:
-{{pause:list}} la percepción de la situación
-{{pause:list}} la comprensión de la situación y
-{{pause:list}} la proyección de esa situación en el futuro

FIGURA 5.  MODELO DE CONCIENCIA SITUACIONAL DE ENDSLEY Y SU{{pause:acronym}} RELACIÓN CON LOS PROCESOS DE
## TOMA{{pause:acronym}} DE DECISIÓN Y DE EJECUCIÓN ASÍ COMO DE FACTORES EXTERNOS E INDIVIDUALES
...
FIGURA 6. ELEMENTOS QUE INFLUENCIAN LA CONCIENCIA SITUACIONAL (ISAAC{{pause:acronym}} Y RUITENBERG 1997)
...
En TRM{{pause:acronym}} se trabaja mucho con el concepto de conciencia situacional y se incide en que cuando al modelo mental le falta información la mente lo rellena realizando asunciones basadas en experiencias pasadas o en lo más probable De aquí hay dos elementos vitales para seguridad:
...
## 3.3 Carga de trabajo mental El concepto de carga de trabajo mental se ha investigado en una amplia variedad de campos tales como la aviación el entorno ATC{{pause:acronym}} en particular las operaciones militares o la conducción de vehículos La definición de carga de trabajo mental considera este concepto de acuerdo a un marco  de  factores  de  estrés  que  interactúan  en  un  individuo  y que por  tanto  tienen  un impacto  en  el  rendimiento  humano    Un  gran  número  de  estudios  científicos  señalan  3 dimensiones fundamentales que afectan la carga mental de trabajo:
-{{pause:list}} Presión temporal de la tarea (tiempo disponible tiempo necesario)
-{{pause:list}} Recursos cognitivos de procesamiento que demanda la tarea
...
## 3) Anticipación
1) Agrupar los tráficos según necesidades (autorizados a ILS{{pause:acronym}} versus tráficos en espera)
...
-{{pause:list}} La comunicación humana Conocemos bien la importancia de la comunicación en el entorno ATC{{pause:acronym}} y sabemos lo que puede suponer una  incidencia al  respecto:  un  fallo de comunicación  entre  torres  cuyo  resultado  es que los controladores no puedan hablarse entre sí para pasar los aviones de un sector a otro o iniciar  una  maniobra  de  aproximación  supone  una  urgencia  sobre  la  que  debemos  actuar inmediatamente dadas sus consecuencias
...
-{{pause:list}} Con independencia de la voluntad que tengamos por actuar de forma coordinada y de la corrección con la que me expreso pueden producirse distorsiones que no son “culpa de nadie” pero que desembocan en un malentendido y por tanto en un incidente
-{{pause:list}} Quien mejor comunica es quien mejor escucha
-{{pause:list}} Aquel que comunica tiene la responsabilidad de asegurarse de que el mensaje ha llegado adecuadamente Si no es así debe buscar vías alternativas para conseguirlo
...
-{{pause:list}} La fatiga La fatiga es un estado natural del individuo que forma parte de su condición humana y que en la mayor parte de los casos no tiene un impacto significativo en la persona Sin embargo si no se presta atención a este estado su impacto en las capacidades físicas y mentales del individuo pueden ser muy importantes
...
Trabajar durante la noche es una característica inherente a la ocupación de CTA{{pause:acronym}} y este turno presenta una serie de peculiaridades respecto de la fatiga que le hacen diferente respecto del mismo  trabajo  desarrollado  durante  el  día  ya  que  tanto  las  condiciones  del  entorno  (por ejemplo  físicas  como  la  falta  de  luz  o  propias  del  tráfico  como  la  reducción  de  la  afluencia) como  las  del  propio  individuo  (fisiológicas)  son  distintas Por  otra  parte  hay  otros  factores inductores de fatiga no relacionada con los procesos circadianos que están vinculados con la carga de trabajo mental sostenida en el tiempo y que también pueden combinarse con factores circadianos con el estrés y con otros factores personales
Para  entender  mejor  la  relación  que  existe  entre  el  trabajo  de  CTA{{pause:acronym}}  y  la  fatiga  así  como  la necesidad de saber gestionar dicho estado es preciso hacer un repaso respecto de los principios científicos que rigen el patrón del sueño del ser humano
...
Según  la  Organización  Mundial de  la  Salud  (OMS{{pause:acronym}})  y  la National  Sleep  Foundation  (EEUU{{pause:acronym}})  un adulto  entre  los  18  y  los  64  años  debe  dormir  un  promedio  diario  de  8  horas  para  poder
...
a el sueño sin movimientos rápidos del ojo (sueño no-REM{{pause:acronym}}
## 2
) y b el sueño con movimientos rápidos del ojo (sueño REM{{pause:acronym}}) El sueño no-REM{{pause:acronym}} o fase de sueño lento se divide a su vez en cuatro fases con características diferentes así que en total se pueden distinguir sumando la fase de sueño REM{{pause:acronym}} cinco fases que  se  alternan  de  forma  cíclica  mientras  la  persona  permanece  dormida  (cada  90/100 minutos aproximadamente comienza un nuevo ciclo de sueño en el que los últimos 20 o 30 minutos se corresponden con la fase REM{{pause:acronym}}):
...
➢ Fase  II{{pause:acronym}}:  en  esta  fase  el  sistema  nervioso  bloquea  las  vías  de  acceso  de  la  información sensorial  lo  que  origina  una  desconexión  con  el  entorno  facilitándose  por  tanto  la actividad de dormir Esta fase ocupa el 50% del tiempo de sueño en una persona adulta
...
➢ Fase III{{pause:acronym}}: es un sueño más profundo (denominado DELTA{{pause:acronym}}) donde el bloqueo sensorial se intensifica   Si   el   individuo   se   despierta   durante   esta   fase   se   siente   confuso   y desorientado  En  esta  fase  no  se  sueña  se  produce  una  disminución  del  10  al  30  por ciento de la tensión arterial y del ritmo respiratorio y se incrementa la producción de la hormona del crecimiento El tono muscular es aún más reducido que en fase II{{pause:acronym}} y tampoco hay movimientos oculares
➢ Fase IV{{pause:acronym}}: es la fase de mayor profundidad del sueño en la que la actividad cerebral es más lenta  (predominio  de  actividad  delta)  Al  igual  que  la  fase  III{{pause:acronym}}  es  esencial  para  la recuperación  física  y  especialmente  psíquica  del  organismo  (déficits  de  fase III{{pause:acronym}}  y  IV{{pause:acronym}}

## 2
Las siglas REM{{pause:acronym}} se corresponden con el nombre en inglés “Rapid Eye Movements”
...
➢ Proceso Circadiano (C) es el reloj corporal interno que regula funciones como la temperatura la producción hormonal etc rigiéndose por un patrón de 24 horas aproximadamente Su pico más bajo de actividad ocurre durante la segunda parte de la noche (aproximadamente entre las 3 y las 6 am)  Este mínimo conocido como mínimo de la ventana circadiana (WOCL{{pause:acronym}}) coincide con el momento donde se alcanza la temperatura basal mínima corporal produciéndose entonces en el individuo la mayor somnolencia y la menor capacidad de desempeño
...
## 5.5 Carga de trabajo fatiga y nivel de desempeño La  Organización de  Aviación  Civil  Internacional  (OACI{{pause:acronym}})  en  el Documento 9966{{pause:doc}}  Manual  para  la supervisión de los enfoques de gestión de la fatiga de 2016 define la fatiga como aquel estado fisiológico que se caracteriza por una reducción de la capacidad de desempeño mental o físico debido  a  la  falta  de  sueño  o  a  períodos  prolongados  de  vigilia  fase  circadiana  y/o  carga  de trabajo (actividad mental y/o física) y que puede menoscabar el estado de alerta de una persona y su capacidad para desempeñar sus funciones relacionadas con la seguridad operacional
...
## FIGURA 8  LEY{{pause:acronym}} DE YERKES-DODSON
...
## 5.6 El Reglamento (UE{{pause:acronym}}) 2017/373 y las SARPS{{pause:acronym}} de OACI{{pause:acronym}} sobre la gestión de la fatiga Tanto la Unión Europea (UE{{pause:acronym}}) como OACI{{pause:acronym}} han establecido reglamentos y normas relativos a la gestión de la fatiga en el caso de la UE{{pause:acronym}} también respecto de la gestión del estrés aspecto que se tratará en el apartado correspondiente a este estado
La Unión Europea refleja los requisitos sobre la gestión de la fatiga relativa a los controladores de tránsito aéreo en el Reglamento de Ejecución (UE{{pause:acronym}}) 2017/373 de 1 de marzo de 2017 de la Comisión  por  el  que  se  establecen  requisitos  comunes  para  los  proveedores  de  servicios  de gestión del tránsito aéreo/ aérea y otras funciones de la red de gestión del tránsito aéreo y su supervisión En concreto en su Anexo IV{{pause:acronym}} Sección 3 donde aparecen los Requisitos sobre  Factores  Humanos Las  disposiciones  de  este  Reglamento  que  entra  en  vigor  el 02/01/2020  se  complementan  con  las  denominadas Easy  Rules de  EASA{{pause:acronym}}  (European  Aviation Safety Agency) donde para cada requisito o Implementing Rule definido en dicho Reglamento se describen medios aceptables de cumplimiento (AMC{{pause:acronym}}) y material guía (GM{{pause:acronym}})
Otro  Reglamento  a  tener  en  cuenta  es  el  Reglamento  de  Ejecución  (UE{{pause:acronym}})  2015/1018  de  la Comisión de 29 de junio de 2015 por el que se establece una lista de clasificación de los sucesos en  la  aviación  civil  de  notificación  obligatoria  En  su  anexo  III{{pause:acronym}}  respecto  de  los  Sucesos

relacionados con los servicios e instalaciones de  aérea establece la obligatoriedad de  notificación  tanto  para  el  proveedor  de  servicios  de  tránsito  aéreo  como  para  el  CTA{{pause:acronym}} respecto de “la fatiga que repercuta o pueda repercutir en la capacidad de ejercer de forma segura las funciones de  aérea o tránsito aéreo” Las  notificaciones  de  fatiga  constituyen  una  fuente  de  información  esencial  para  poder entender analizar y evaluar los riesgos asociados a la fatiga tanto si ésta se gestiona mediante un FRMS{{pause:acronym}} o de acorde a los límites prescriptivos
ENAIRE cuenta con un sistema integrado de gestión de riesgos de fatiga y estrés denominado FSRMS{{pause:acronym}} Fatigue and Stress Risk Management System
...
## FATIGA
¿CTA{{pause:acronym}} consciente de la fatiga?
...
## FIGURA 9  RELACIÓN ENTRE{{pause:acronym}} LA FATIGA Y LA SEGURIDAD OPERACIONAL
...
Por tanto  trabajar  por  la  noche es una  característica  inherente  a  la  ocupación de  CTA{{pause:acronym}}  y este turno presenta una serie de peculiaridades que le hacen diferente respecto del mismo trabajo desarrollado durante el día ya que tanto las condiciones del entorno (por ejemplo: físicas -falta de  luz-  o  propias  del  tráfico -reducción  de  la  afluencia-)  como  las  del  propio  individuo (fisiológicas) son distintas
...
## COMO AFECTA AL{{pause:acronym}} INDIVIDUO
...
FIGURA 10  MODELO TRANSACCIONAL DEL ESTRÉS DE COX{{pause:acronym}}-MACKAY FUENTE: “MANAGING STRESS IN{{pause:acronym}} ATM{{pause:acronym}}”
## EUROCONTROL
...
En  términos  generales  el  estrés  experimentado  por  un  controlador  de  tráfico  aéreo  en  el trabajo es una función de sus niveles subyacentes de estrés relacionados con su estilo de vida su salud y bienestar la personalidad el entorno organizativo/laboral sus niveles de satisfacción vitales así como el estrés agudo impuesto por las condiciones operativas De acuerdo con EASA{{pause:acronym}} (GM1 ATSOR{{pause:acronym}}.310 Stress – RE{{pause:acronym}} 2017/373) podemos distinguir tres fuentes principales de estrés en  el  ámbito  de  control aéreo: estresores  ambientales/físicos estresores  relacionados  con  la tarea y relativos al individuo
...
La  gestión  de  riesgos  relativos  al  estrés  debe  ser  considerada  un  componente  vital  de  la organización  al  proporcionar  una  oportunidad  significativa  de  maximizar  el  bienestar  del personal ATM{{pause:acronym}} con el propósito final de mejorar la seguridad y la eficiencia  En ese sentido la normativa europea sugiere una serie de medidas de mitigación:
...
Critical Incident Stress Management o CISM{{pause:acronym}} describe el conjunto de medidas y estrategias para afrontar  satisfactoriamente  estos  sucesos  y  prevenir  las  enfermedades  y  consecuencias negativas en la salud de los mismos
...
En un entorno ATC{{pause:acronym}} pueden ser considerados incidentes críticos los siguientes ejemplos:
o Accidentes
...
Dada  la  importancia  de  las  consecuencias  descritas  ENAIRE  decidió  implantar  un  programa CISM{{pause:acronym}}  como  una  ayuda  estructurada  a  la  reacción  humana  ante  incidencias  ATC{{pause:acronym}}  de  carácter traumático  con el  objeto  de  moderar el  impacto  del  mismo  sobre el  controlador de tránsito aéreo y acelerar su regreso a la normalidad laboral
La  metodología  propuesta  consiste  en  la  implementación  de  un  programa  CISM{{pause:acronym}}  en  la organización basada en un modelo Peers Peer es la denominación inglesa que en este caso hace   referencia   a   un   controlador   de   apoyo   formado   específicamente   para   atender psicológicamente  a  otros  controladores  tras  la  ocurrencia  de  un  incidente  crítico  Esta intervención se ha de complementar con asistencia psicológica profesional cuando se estime necesario
El  programa  ha  de  disponer  de  un  grupo  de  Peers  voluntarios  seleccionados  y  formados específicamente  en  CISM{{pause:acronym}}  siguiendo  las  recomendaciones  y  estándares  de  la  International Critical Incident Stress Foundation (ICISF{{pause:acronym}})
Los  Peers  deben  ser  controladores  aéreos  con  una  amplia  experiencia  en  la  profesión específicamente seleccionados y formados para apoyar a otros controladores que precisen una intervención  debido  al  estrés  generado  por  un  incidente  crítico  Son  controladores  que  se ofrecen voluntarios para operar el CISM{{pause:acronym}}  Las principales tareas a realizar serán:
...
− Ser emocionalmente estable − Ser sensible a los problemas y saber escuchar a los demás − Con actitud abierta al aprendizaje − Aceptar estar disponible para sus compañeros en su tiempo libre si fuera necesario − Ser fiable: una persona en la que uno sienta que puede depositar su confianza − Ser una persona respetada por el resto tanto por sus cualidades profesionales como por sus cualidades humanas − Que entienda la importancia de la confidencialidad − Tener habilidades sociales y capacidad de empatizar − Conocer  las  limitaciones  del  CISM{{pause:acronym}}:  ser  consciente  de  que  su  labor  es  proporcionar primeros auxilios no asistencia psicológica profesional − Tener experiencia en la gestión de situaciones inusuales − Tener conocimiento operacional adecuado del entorno ATC{{pause:acronym}}

Podemos resumir el programa en cinco fases:
-{{pause:list}} Comunicación  y  divulgación  Comprende  la  comunicación  y  divulgación  iniciales  del programa CISM{{pause:acronym}} a todo el colectivo de control
-{{pause:list}} Selección  y  Formación  de  los  Peers  y  Grupos  de  interés  Comprende  la  valoración  y selección de los candidatos así como la formación de los candidatos seleccionados en base estándares reconocidos a nivel internacional  En el caso de ENAIRE el proceso de selección se  basa  en  requisitos  establecidos  en  el  documento  de  EUROCONTROL  (2008)  Human Factors – Critical  Incident  Stress  Management:  User  Implementation  Guidelines  edición
## 2.0.
-{{pause:list}} Intervención del Peer con el controlador aéreo que ha experimentado un incidente crítico e intervenciones posteriores si fuera necesario
...
-{{pause:list}} Evaluación periódica del programa Es necesario desarrollar y llevar a cabo la evaluación periódica del programa CISM{{pause:acronym}} con el fin de medir la efectividad y buscar posibles mejoras del mismo Normalmente este tipo de evaluación se realiza mediante cuestionarios a los  usuarios  del  programa  totalmente  anónimos  Todo  ello  quedará  recogido  en  un informe  anual  del  programa  CISM{{pause:acronym}}  A  efectos  de  estadística  se  llevará  un  control  del número de veces que se activa el programa respecto al número de incidencias así como cuántas  activaciones  del  programa  necesitan  llegar  a  la  intervención  de  Psicólogos
## Profesionales
...
## 7.2 Modelo TEM{{pause:acronym}} (Threat and Error Management) El modelo TEM{{pause:acronym}} es un concepto desarrollado por OACI{{pause:acronym}} que busca identificar el origen y la gestión de los errores en la interacción entre los controladores y su contexto operacional (organización procedimientos condiciones ambientales)  Este método permite establecer cómo se originan los errores cómo se responde a los errores cómo se detectan y cuáles son las consecuencias
...
## FIGURA 11  EL MODELO TEM{{pause:acronym}} DEFINIDO POR OACI{{pause:acronym}}
...
➢ Estados no deseados Los  errores  y  amenazas  que  forman  parte  del  trabajo  cotidiano  del  controlador  pueden generar estados no deseados (undesired states) y estas situaciones no deseables pueden convertirse  en  un riesgo  para  la  seguridad  Para  el  método  TEM{{pause:acronym}}  como  herramienta  en  el análisis  de  los  riesgos  a  la  seguridad  de  las  operaciones  es  tan  importante  estudiar  las circunstancias no deseadas que se pueden crear en el desarrollo de las operaciones como el análisis de los errores y amenazas potenciales
...
Lo más relevante de cara a los estados no deseados es que de forma implícita el control de tránsito aéreo consiste en la detección de estados no deseados tanto los que aparecen de forma natural por la propia evolución del tráfico y del contexto como los que se generan por la  propia  actuación  ATC{{pause:acronym}}  Entrenar  la  detección de  estados  no  deseados  es  esencial  para consolidar estrategias de trabajo seguros y el conocimiento en factores humanos permite adelantarse a amenazas internas y estados no deseados

## 8. BIBLIOGRAFÍA
ASOCIACIÓN ESPAN{{pause:acronym}}̃OLA{{pause:acronym}} DE NORMALIZACIÓN Y CERTIFICACIÓN (2001) Principios Ergonómicos Relativos a la Carga de Trabajo Mental UNE{{pause:acronym}}-EN ISO{{pause:acronym}} 10075-1 y 2. Madrid: AENOR{{pause:acronym}}
ASOCIACIÓN ESPAN{{pause:acronym}}̃OLA{{pause:acronym}} DE NORMALIZACIÓN Y CERTIFICACIÓN (2005) Principios Ergonómicos Relativos a la Carga de Trabajo Mental UNE{{pause:acronym}}-EN ISO{{pause:acronym}} 10075-3. Madrid: AENOR{{pause:acronym}} 21 p
...
Edwards E (1988) “Introductory Overview” in EL Wiener & DC{{pause:acronym}} Nagel (Eds) Human Factors in Aviation San Diego CA{{pause:acronym}}: Academic Press
Endsley MR{{pause:acronym}} (1999) “Situational Awareness in Aviation Systems” In Handbook of Aviation Human Factors ed by Garland DJ{{pause:acronym}} Wise JA{{pause:acronym}} and Hopkin VD{{pause:acronym}}  Mahwah NJ{{pause:acronym}}: Lawrence
...
EUROCONTROL (2014) Systems Thinking for Safety: Ten Principles A White Paper  Moving Towards Safety II{{pause:acronym}} Brussels: EUROCONTROL
EUROCONTROL (2013) From Safety-I to Safety-II{{pause:acronym}} A White Paper Brussels: EUROCONTROL
EUROCONTROL/FAA{{pause:acronym}} Action Plan 15 Safety (2010) Human Performance in Air Traffic Management Safety A White Paper Brussels: EUROCONTROL
...
Everly GS{{pause:acronym}} (2006) Assisting Individuals in Crisis 4th edn Ellycott City MD{{pause:acronym}}: International Critical
## Incident Stress Foundation
Everly GS{{pause:acronym}} Mitchell JT{{pause:acronym}} (1997) Innovations in Disaster and Psychology Volume Two: Critical Incident Stress Management a New Era and Standard of Care in Crisis Intervention Ellycott City MD{{pause:acronym}}: Chevron

Hollnagel E (2014) Safety-I and Safety-II{{pause:acronym}} The Past and Future of Safety Management Farnham:
## Ashgate
Hollnagel E (2009) The ETTO{{pause:acronym}} Principle: Efficiency-Thoroughness Trade-off: Why Things that Go
## Right Sometimes Go Wrong Ashgate Publishing Ltd
Hopkin VD{{pause:acronym}} (1995) Human Factors in Air Traffic Control London: Taylor and Francis
Isaac AR{{pause:acronym}} and Ruitenberg B (1999)  Air Traffic Control: Human Performance Factors Aldershot:
## Ashgate
Leonhardt J and Vogt J (Eds) (2006) Critical Incident Stress Management CISM{{pause:acronym}} in Aviation
Aldershot UK{{pause:acronym}}: Ashgate
Mitchell JT{{pause:acronym}} (2006) Critical Incident Stress Management (CISM{{pause:acronym}}): Group Crisis Intervention   4th edn Ellycott City MD{{pause:acronym}}: International Critical Incident Stress Foundation
Mitchell JT{{pause:acronym}} Everly GS{{pause:acronym}} (1996) Critical Incident Stress Debriefing An Operation Manual for the Prevention of Traumatic Stress among Emergency Services and Disaster Workers 2nd edn
Ellycott City MD{{pause:acronym}}: Chevron
Mitchell JT{{pause:acronym}} Everly GS{{pause:acronym}} (1994) Human Elements Training for Emergency Services Public Safety and Disaster Personnel: an Instructional Guide to Teaching Debriefing Crisis Intervention and Stress Management Programs Ellycott City MD{{pause:acronym}}: Chevron
OACI{{pause:acronym}} (2016) Manual para la Supervisión de los Enfoques de Gestión de la Fatiga  Doc 9966{{pause:doc}}. 2nd ed  Montreal: OACI{{pause:acronym}}
OACI{{pause:acronym}} (2011) Manual sobre la Observación Continua del Programa Universal de Auditoría de la Vigilancia de la Seguridad Operacional Doc 9735{{pause:doc}} AN{{pause:acronym}}/960. 3rd ed Montreal: OACI{{pause:acronym}}
OACI{{pause:acronym}} (2005) Manejo de Amenazas y Errores (TEM{{pause:acronym}}) en el Control de Tránsito Aéreo CIR{{pause:acronym}} 314 AN{{pause:acronym}}/178  Montreal: OACI{{pause:acronym}}
OACI{{pause:acronym}} (1994) Anexo 13 al Convenio sobre Aviación Civil Internacional – Investigación de Accidentes e incidentes de Aviación Montreal: OACI{{pause:acronym}}
...
Rasmussen J (1983) “Skills Rules and Knowledge: Signals Signs and Symbols and other Distinctions in Human Performance Models” IEEE{{pause:acronym}} Transactions on Systems Man and
## Cybernetics 13 257-266.

Reason J (1997) Managing the Risks of Organizational Accidents Farnham: Ashgate
Reason J (1990) Human error New York: Cambridge University Press
Reason J (1987) “Generic Error-Modelling Systems (GEMS{{pause:acronym}}) A Cognitive Framework for Locating Common Human Error Forms” in New Technology and Human Error ed by Rasmussen K Duncan K and Leplat J Chichester:Wiley 63-83.
Reglamento de Ejecución (UE{{pause:acronym}}) 2017/373 por el que se establecen los Requisitos Comunes para los Proveedores de Servicios de Gestión del Tránsito Aéreo/ Aérea y otras Funciones de la Red de Gestión del Tránsito Aéreo y su Supervisión por el que se derogan el Reglamento (CE{{pause:acronym}}) nº 482/2008 y los Reglamentos de Ejecución (UE{{pause:acronym}}) nº 1034/2011 (UE{{pause:acronym}}) nº 1035/2011 y (UE{{pause:acronym}}) 2016/1377 y por el que se modifica el Reglamento (UE{{pause:acronym}}) nº 677/2011. Bruselas: La Comisión
## Europea
Reglamento (UE{{pause:acronym}}) 2015/340 de la Comisión de 20 de febrero de 2015 por el que se establecen Requisitos Técnicos y Procedimientos Administrativos relativos a las Licencias y los Certificados de los Controladores de Tránsito Aéreo en virtud del Reglamento (CE{{pause:acronym}}) nº 216/2008 del Parlamento Europeo y del Consejo se modifica el Reglamento de Ejecución (UE{{pause:acronym}}) nº 923/2012 de la Comisión y se deroga el Reglamento (UE{{pause:acronym}}) nº 805/2011 de la Comisión Bruselas: La Comisión
## Europea
Reglamento (UE{{pause:acronym}}) 376/2014 del Parlamento Europeo y del Consejo de 3 de abril de 2014 relativo a la Notificación de Sucesos en la Aviación Civil que modifica el Reglamento (UE{{pause:acronym}}) nº 996/2010 del Parlamento Europeo y del Consejo y por el que se derogan la Directiva 2003/42/CE{{pause:acronym}} del Parlamento Europeo y del Consejo y los Reglamentos (CE{{pause:acronym}}) nº 1321/2007 y (CE{{pause:acronym}}) nº 1330/2007 de la Comisión Bruselas: Parlamento Europeo y Consejo de la Unión Europea
Salvendy G (2012) The Handbook of Human Factors and Ergonomics  4 th edn Hoboken NJ{{pause:acronym}}:
## John Wiley & Sons Inc
Shorrock S Williams C (2017) Human Factors and Ergonomics in Practice  Improving System Performance and Human Well-Being in the Real World Boca Raton FL{{pause:acronym}}: CRC{{pause:acronym}} Press Simon H (1957)  Models of Man (Social and Rational) New York: John Wiley and Sons
